        ...
        if (in_array($fileActualExt,$allowed)){
            if ($fileError === 0 ){
                if ($fileSize <  8388608999){
                    ...
                    $sql = mysqli_query($conn, "INSERT INTO `test`(`test_no`,`question_no`,`type`,`image`,`answer`,`modify_date`,`section`) VALUES ('$test_no','$question_no','$type','$fileNameNew','$answer','$modify_date','$section')");
                    if ($sql == true) {
