...
<head>
    ...
    <title>Create Test-Speaking: Re Tell Lecture | Origin Overseas - PTE tutors </title>
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Create Test</a></li>
                                 <li class="breadcrumb-item active" aria-current="page"><span>Speaking: Re Tell Lecture </span></li>
                            </ol>
                        </nav>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-3 col-lg-12 col-md-4">
                                                                         <div class="upload mt-4 pr-md-4" style="border:none;">
                                                                            <input type="file" id="profileImg" class="dropify" data-default-file="" name="profileImg" accept="audio/*,video/*" required="">
                                                                            <p class="mt-2"><i class="flaticon-cloud-upload mr-1"></i> <b style="color: red">Upload Audio/Video</b></p>
                                                                        </div>
                                                                    </div>
        ...
        if (in_array($fileActualExt,$allowed) || in_array($fileActualExt,$allowed_vid)){
            if ($fileError === 0 ){
                ...
                if ($sql == true) {
                    ...
                    if($question_no <= 4)
                    {
                        ?><script>location.replace("speaking_re_tell_lecture.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no ?>&question=success");</script><?php
                    }
                    else
                    {
                        ?><script>location.replace("speaking_short_question.php?testno=<?php echo $test_no; ?>&question_no=1&question=success");</script><?php    
                    }
                }
                else
                {
                    ?><script type="text/javascript">location.href = "speaking_re_tell_lecture.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&error=1";</script><?php
                }
            }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "speaking_re_tell_lecture.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&file_error=1";
                    </script>
                    <?php
            }
        }else{
            ?>
            <script type="text/javascript">
            window.location = "speaking_re_tell_lecture.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&type=1"; 
            </script>
            <?php
        }
    }
