...
<head>
    ...
    <title>Create Test-Listening: Highlight Correct Summary | Origin Overseas - PTE tutors </title>
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Create Test</a></li>
                                 <li class="breadcrumb-item active" aria-current="page"><span>Listening: Highlight Correct Summary </span></li>
                            </ol>
                        </nav>
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option1" >
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="0" id="radio1" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                             <textarea  name="option1" class="form-control" id="opt1"></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="1" id="radio2" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                             ...
                                                                             <textarea  name="option2" class="form-control" id="opt2"></textarea>
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="2" id="radio3" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                             ...
                                                                             <textarea  name="option3" class="form-control" id="opt3"></textarea>
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="3" id="radio4" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                             ...
                                                                             <textarea  name="option4" class="form-control" id="opt4"></textarea>
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option5">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="4" id="radio5" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                             ...
                                                                             <textarea  name="option5" class="form-control" id="opt5"></textarea>
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="5" id="radio6" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                             ...
                                                                             <textarea  name="option6" class="form-control" id="opt6"></textarea>
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option7">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="6" id="radio7" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                             ...
                                                                             <textarea name="option7" class="form-control" id="opt7"></textarea>
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option8">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="7" id="radio8" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                             ...
                                                                             <textarea name="option8" class="form-control" id="opt8"></textarea>
                                                                         </div>
                                                                        </div>
                                                                    </div>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($tot_options != $options) {
            ?>
            <script type="text/javascript">    
                window.location = "listening_highlight_correct_summary.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no ?>&missing=1";
            </script>
            <?php
        }
        $answer = $option[$radio];
        ...
        if (in_array($fileActualExt,$allowed)){
            if ($fileError === 0 ){
                if ($fileSize <  8388608999999){
                    ...
                    if ($sql == true) {
                        ...
                        if($question_no <= 2)
                        {
                            ?><script>location.replace("listening_highlight_correct_summary.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no ?>&question=success");</script><?php
                        }
                        else
                        {
                            ?><script>location.replace("listening_single_answer.php?testno=<?php echo $test_no; ?>&question_no=1&question=success");</script><?php    
                        }
                    }
                    else
                    {
                        ?><script type="text/javascript">location.href = "listening_highlight_correct_summary.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&error=1";</script><?php
                    }
                }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "listening_highlight_correct_summary.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&high=1";
                    </script>
                    <?php
                }
            }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "listening_highlight_correct_summary.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&file_error=1";
                    </script>
                    <?php
            }
        }else{
            ?>
            <script type="text/javascript">
            window.location = "listening_highlight_correct_summary.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&type=1"; 
            </script>
            <?php
        }
    }
