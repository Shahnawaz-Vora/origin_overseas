...
<head>
    ...
    <title>Create Test-Speaking: Read Aloud | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Speaking: Read a Loud </span></li>
                            </ol>
                        </nav>
                ...
                <div class="container">
                    <div class="row layout-spacing">
                        <div class="col-lg-12 col-12 layout-spacing">            
                            ...
                            <form id="general-info" class="section general-info" method="POST" action="">
                                 ...
                                 <div class="row">
                                    <div class="col-md-11 mx-auto">
                                        <div class="form-group" align="center">
                                            <button class="btn btn-primary btn-rounded" name="submit" type="submit" style="width: 110px;margin-top: -10px;font-family: sans-serif;letter-spacing: 1.7px;margin-bottom: 15px">Next</button>
                                        </div>
                                    </div>
                                 </div> 
                            </form>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        $modify_date = date("Y/m/d");
        $question_no = $_GET['question_no'];
        $sql = "INSERT INTO `test`(`test_no`,`question_no`,`type`,`questionText`,`answer`,`modify_date`,`section`) VALUES ('$test_no','$question_no','$type','$question_text','$answer','$modify_date','$section')";
        ...
        if ($run == true)
        {
            ...
            if(isset($_GET['test_name']) &&  isset($_GET['test_price']))
            {
                ...
                $sql = mysqli_query($conn, "update manage_test set test_name='$test_name',test_price='$test_price' where test_no='$test_no'");
            }
            if($question_no <= 7)
            {
                ?><script>location.replace("speaking_read_a_loud.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no ?>&question=success");</script><?php
            }
            else
            {
                ?><script>location.replace("speaking_repeat_sentence.php?testno=<?php echo $test_no; ?>&question_no=1&question=success");</script><?php    
            }
        }
        else
        {
            ?><script type="text/javascript">location.href = "speaking_read_a_loud.php?testno=<?php echo $test_no; ?>&question=<?php echo $question_no; ?>&error=1";</script><?php
        }
