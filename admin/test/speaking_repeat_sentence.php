...
<head>
    ...
    <title>Create Test-Speaking: Repeat Sentence | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                 ...
                                 <li class="breadcrumb-item active" aria-current="page"><span>Speaking: Repeat Sentence </span></li>
                            </ol>
                        </nav>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-2 col-lg-12 col-md-4">
                                                                        <div class="upload mt-4 pr-md-4" style="border:none">
                                                                            <input type="file" id="profileImg" class="dropify" data-default-file="" data-max-file-size="30M" name="profileImg" accept="audio/* "/ required="">
        ...
        if (in_array($fileActualExt,$allowed)){
            if ($fileError === 0 ){
                if ($fileSize <  8388608999){
                    ...
                    $sql = mysqli_query($conn, "INSERT INTO `test`(`test_no`,`question_no`,`type`,`audio`,`answer`,`transcript`,`modify_date`,`section`) VALUES ('$test_no','$question_no','$type','$fileNameNew','$answer','$transcript','$modify_date','$section')");
                    if ($sql == true) {
                        ...
                        if($question_no <= 10)
                        {
                            ?><script>location.replace("speaking_repeat_sentence.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no ?>&question=success");</script><?php
                        }
                        else
                        {
                            ?><script>location.replace("speaking_describe_image.php?testno=<?php echo $test_no; ?>&question_no=1&question=success");</script><?php    
                        }
                    }
                    else
                    {
                        ?><script type="text/javascript">location.href = "speaking_repeat_sentence.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&error=1";</script><?php
                    }
                }else{
                    ?>
                    <script type="text/javascript">    
                    window.location = "speaking_repeat_sentence.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&high=1";
                    </script>
                    <?php
                }
        }else{
                ?>
                <script type="text/javascript">
                window.location = "speaking_repeat_sentence.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&file_error=1";
                </script>
                <?php
            }
        }else{
            ?>
            <script type="text/javascript">
            window.location = "speaking_repeat_sentence.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&type=1"; 
            </script>
            <?php
        }
    }
