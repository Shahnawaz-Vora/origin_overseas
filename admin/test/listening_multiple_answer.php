...
<head>
    ...
    <title>Create Test-Listening: Multiple Choice, Choose Multiple Answers | Origin Overseas - PTE tutors </title>
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Create Test</a></li>
                                 <li class="breadcrumb-item active" aria-current="page"><span>Listening: Multiple Choice, Choose Multiple Answers </span></li>
                            </ol>
                        </nav>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-11 mx-auto">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-10 col-lg-12 col-md-11 mx-md-auto mt-4" style="padding-left: 28px;padding-right: 28px">      
                                                                        <h6 class="">Question:</h6><br>
                                                                        <div class="row" style="margin-top: -45px">
                                                                             <textarea rows="4" cols="108" class="form-control" id="question_text" name="question" required=""></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row" >
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option1" >
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="checkbox" value="0" name="checkbox" id="checkbox1" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="btn-group w-100">
                                                                            <input type="checkbox" value="1" name="checkbox" id="checkbox2" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option3">
                                                                        <div class="form-group">
                                                                            <label for="option1"  style="margin-left: 54px;">Option 3</label>
                                                                             <div class="btn-group w-100">
                                                                            <input type="checkbox" value="2" name="checkbox" id="checkbox3" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="btn-group w-100">
                                                                            <input type="checkbox" value="3" name="checkbox" id="checkbox4" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                ...
                                                                <div class="row" >
                                                                    <div class="col-md-12" style="display: none;" id="option5">
                                                                        <div class="form-group">
                                                                            <label for="option1"  style="margin-left: 54px;">Option 5</label>
                                                                             <div class="btn-group w-100">
                                                                            <input type="checkbox" value="4" name="checkbox" id="checkbox5" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option6">
                                                                        <div class="form-group">
                                                                            <label for="option1"  style="margin-left: 54px;">Option 6</label>
                                                                             <div class="btn-group w-100">
                                                                            <input type="checkbox" value="5" name="checkbox" id="checkbox6" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option7">
                                                                        <div class="form-group">
                                                                             ...
                                                                             <div class="btn-group w-100">
                                                                            <input type="checkbox" value="6" name="checkbox" id="checkbox7" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option8">
                                                                        <div class="form-group">
                                                                             ...
                                                                             <div class="btn-group w-100">
                                                                            <input type="checkbox" value="7" name="checkbox" id="checkbox8" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                           
                                                                             <input type="text"  name="option8" class="form-control" id="opt8">
                                                                         </div>
                                                                        </div>
                                                                        <input type="hidden" name="ans" value="" id="ans">
                                                                        <input type="hidden" name="question_no" value="<?php echo $_GET['question_no']; ?>">
...
<?php
    if (isset($_POST['submit'])) {
        ...
        $question_no = trim($_POST['question_no']); 
         ...
         if($ans == null || $ans == "")
        {
              ?>
            <script type="text/javascript">    
                window.location = "listening_multiple_answer.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no ?>&missing=1";
            </script>
            <?php
        }
        else{
        ...
        if (in_array($fileActualExt,$allowed)){
            if ($fileError === 0 ){
                if ($fileSize <  8388608999){
                    ...
                    $sql = mysqli_query($conn , "INSERT INTO test(test_no,question_no,type,answer,audio,transcript,question, option1, option2, option3, option4, option5, option6, option7, option8,modify_date,section) VALUES ('$test_no','$question_no','$type','$ans','$fileNameNew', '$transcript','$question', '$option[0]', '$option[1]', '$option[2]', '$option[3]', '$option[4]', '$option[5]', '$option[6]', '$option[7]','$modify_date','$section') " );
                    if ($sql == true) {
                        ...
                        if($question_no <= 2)
                        {
                            ?><script>location.replace("listening_multiple_answer.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no ?>&question=success");</script><?php
                        }
                        else
                        {
                            ?><script>location.replace("listening_fill_in_the_blanks.php?testno=<?php echo $test_no; ?>&question_no=1&question=success");</script><?php    
                        }
                    }
                    else
                    {
                        ?><script type="text/javascript">location.href = "listening_multiple_answer.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&error=1";</script><?php
                    }
                }else{
                    ?>
                     <script type="text/javascript">
                     window.location = "listening_multiple_answer.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no ?>&high=1";
                     </script>
                     <?php
                }
            }else{
                    ?>
                     <script type="text/javascript">
                    window.location = "listening_multiple_answer.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no ?>&file_error=1";
                    </script>
                     <?php
            }
        }else{
             ?>
             <script type="text/javascript">
                 window.location = "listening_multiple_answer.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no ?>&type=1"; 
               </script>
             <?php
        }
    }
