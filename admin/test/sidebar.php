                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="student" data-parent="#accordionExample">
                            <li>
                                <a href="../student/create_student.php"> Create Student </a>
                            </li>
                            <li>
                                <a href="../student/student_manage_table.php"> Manage Student </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="test" data-parent="#accordionExample">
                            <li>
                                <a href="index.php"> Create Tests </a>
                            </li>
                            <li>
                                <a href="../manage_test_table.php"> Manage Test </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="section_test" data-parent="#accordionExample">
                            <li>
                                <a href="../section_test/"> Create Tests </a>
                            </li>
                            <li>
                                <a href="../manage_section_test_table.php"> Manage Test </a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu">
                        <a href="../evaluation_table.php" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polygon points="12 15 17 21 7 21 12 15"></polygon></svg>
                    ...
                    <li class="menu">
                        <a href="../section_test_evaluation_table.php" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polygon points="12 15 17 21 7 21 12 15"></polygon></svg>
                                <span>Evaluate Section Test</span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="material" data-parent="#accordionExample">
                            <li>
                                <a href="../add_material.php"> Create Material </a>
                            </li>
                            <li>
                                <a href="../manage_materials.php"> Manage Material </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="purchase" data-parent="#accordionExample">
                            <li>
                                <a href="../test_purchase.php" aria-expanded="false" class="dropdown-toggle">Purchase Details</a>
                            </li>
                            <li>
                                <a href="../apps_invoice.php" aria-expanded="false" class="dropdown-toggle">Invoices</a>
                            </li>
                        </ul>
                    </li>
