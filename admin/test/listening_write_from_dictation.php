                ...
                if ($fileSize <  8388608999999){
                    ...
                    if ($sql == true) {
                        ...
                        if($question_no <= 4)
                        {
                            ...
                            $sql = mysqli_query($conn , "SELECT * from test where test_no='$test_no'"); 
                            if(mysqli_num_rows($sql) == 81)
                            {
                                $sql = mysqli_query($conn,"update manage_test set status=1");
                                session_destroy();
                                ?><script>location.href = "../manage_test_table.php"; </script><?php
                            }
                            else
                            {
                                $sql = mysqli_query($conn,"update manage_test set status=0"); 
                                session_destroy();
                                ?><script>location.href = "../manage_test.php"; </script><?php
                            }
                        }
                    }
                    else
