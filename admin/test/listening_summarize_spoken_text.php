    ...
    if (isset($_POST['submit'])) {
        ...
        if (in_array($fileActualExt,$allowed)){
            if ($fileError === 0 ){
                ...
                $sql = mysqli_query($conn, "INSERT INTO test(test_no,question_no,type,answer,audio,transcript,modify_date,section) VALUES ('$test_no','$question_no','$type','$answer','$fileNameNew', '$transcript','$modify_date','$section') ");
                if ($sql == true) {
