...
<head>
    ...
    <title>Create Test-Writing: Essay Writing | Origin Overseas - PTE tutors </title>
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Create Test</a></li>
                                 <li class="breadcrumb-item active" aria-current="page"><span>Writing: Essay Writing </span></li>
                            </ol>
                        </nav>
                                        ...
                                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12 layout-top-spacing">
                                                    <h4><center><b>Essay Writing</b> : Question <?php echo $question_no; ?></center></h4>
                                                    <div class="info">
                                                        <h6 class="pl-2">
                                                       Question Text:</h6><br>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        $modify_date = date("Y/m/d");
        $question_no = $_GET['question_no'];
        $sql = mysqli_query($conn, "INSERT INTO `test`(`test_no`,`question_no`,`type`,`questionText`,`answer`,`modify_date`,`section`) VALUES ('$test_no','$question_no','$type','$question_text','$answer','$modify_date','$section')");
        if ($sql == true) {
            ...
            if($question_no <= 1)
            {
                ?><script>location.replace("writing_essay.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no ?>&question=success");</script><?php
            }
            else
            {
                ?><script>location.replace("reading_single_answer.php?testno=<?php echo $test_no; ?>&question_no=1&question=success");</script><?php    
            }
        }
        else
        {
            ?><script type="text/javascript">location.href = "writing_essay.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&error=1";</script><?php
        }
    }
?>
<?php
