...
<head>
    ...
    <title>Add Material-Speaking: Re Tell Lacture | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Speaking: Re Tell Lacture</span></li>
                            </ol>
                        </nav>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-3 col-lg-12 col-md-4">
                                                                         <div class="upload mt-4 pr-md-4" style="border:none;">
                                                                            <input type="file" id="profileImg" class="dropify" data-default-file="" name="profileImg" required="">
    ...
    if (isset($_POST['submit'])) {
        ...
        if (in_array($fileActualExt,$allowed) || in_array($fileActualExt,$allowed_vid)){
            if ($fileError === 0 ){
                ...
                $sql = mysqli_query($conn, "INSERT INTO material_speaking(type, audio, answer, transcript, modify_date) VALUES ('$type', '$fileNameNew', '$answer', '$transcript', '$modify_date') ");
                if ($sql == true) {
                    ...
                    ?>
                    <script type="text/javascript">
                    window.location = "speaking_re_tell_lecture.php?error=1";
                    </script>
                    <?php
                }
            }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "speaking_re_tell_lecture.php?file_error=1";
                    </script>
                    <?php
            }
        }else{
            ?>
            <script type="text/javascript">
            window.location = "speaking_re_tell_lecture.php?type=1"; 
            </script>
            <?php
        }
    }
