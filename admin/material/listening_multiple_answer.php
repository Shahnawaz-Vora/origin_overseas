...
<head>
    ...
    <title>Add Material-Listening: Multiple Choice, Choose Multiple Answers | Origin Overseas - PTE tutors </title>
        ...
        if (in_array($fileActualExt,$allowed)){
            if ($fileError === 0 ){
                if ($fileSize <  8388608999){
                    ...
                    $sql = mysqli_query($conn, "INSERT INTO material_listening(type, audio, answer, transcript, question, option1, option2, option3, option4, option5, option6, option7, option8, modify_date) VALUES ('$type', '$fileNameNew', '$ans', '$transcript', '$question', '$option[0]', '$option[1]', '$option[2]', '$option[3]', '$option[4]', '$option[5]', '$option[6]', '$option[7]', '$modify_date') ");
                    if ($sql == true) {
                        ...
                        ?>
                         <script type="text/javascript">    
                             window.location = "listening_multiple_answer.php?error=1";
                             </script> 
                         <?php
                    }
                }else{
                    ?>
                     <script type="text/javascript">
                     window.location = "listening_multiple_answer.php?high=1";
                     </script>
                     <?php
                }
            }else{
                    ?>
                     <script type="text/javascript">
                    window.location = "listening_multiple_answer.php?file_error=1";
                    </script>
                     <?php
            }
        }else{
             ?>
             <script type="text/javascript">
                 window.location = "listening_multiple_answer.php?type=1"; 
               </script>
             <?php
        }
    }
