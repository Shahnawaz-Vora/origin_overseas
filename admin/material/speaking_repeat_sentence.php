...
<head>
    ...
    <title>Add Material-Speaking: Repeat Sentence | Origin Overseas - PTE tutors </title>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if (in_array($fileActualExt,$allowed)){
            if ($fileError === 0 ){
                if ($fileSize <  8388608999){
                    ...
                    if ($sql == true) {
                        ...
                        ?>
                        <script type="text/javascript">    
                        window.location = "speaking_repeat_sentence.php?error=1";
                        </script>
                        <?php
                    }
                }else{
                    ?>
                    <script type="text/javascript">    
                    window.location = "speaking_repeat_sentence.php?high=1";
                    </script>
                    <?php
                }
        }else{
                ?>
                <script type="text/javascript">
                window.location = "speaking_repeat_sentence.php?file_error=1";
                </script>
                <?php
            }
        }else{
            ?>
            <script type="text/javascript">
            window.location = "speaking_repeat_sentence.php?type=1"; 
            </script>
            <?php
        }
    }
