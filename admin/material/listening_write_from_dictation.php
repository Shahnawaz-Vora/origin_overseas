...
<head>
    ...
    <title>Add Material-Listening: Write From Dicatation | Origin Overseas - PTE tutors </title>
        ...
        if (in_array($fileActualExt,$allowed)){
            if ($fileError === 0 ){
                if ($fileSize <  8388608999999){
                    ...
                    $sql = mysqli_query($conn, "INSERT INTO material_listening(type, audio, Answer, transcript, modify_date) VALUES ('$type', '$fileNameNew', '$answer', '$transcript', '$modify_date') ");
                    if ($sql == true) {
                        ...
                        ?>
                        <script type="text/javascript">    
                        window.location = "listening_write_from_dictation.php?error=1";
                        </script>
                        <?php
                    }
                }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "listening_write_from_dictation.php?high=1";
                    </script>
                    <?php
                }
            }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "listening_write_from_dictation.php?file_error=1";
                    </script>
                    <?php
            }
        }else{
            ?>
            <script type="text/javascript">
            window.location = "listening_write_from_dictation.php?type=1"; 
            </script>
            <?php
        }
    }
