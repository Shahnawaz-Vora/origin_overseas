...
<head>
    ...
    <title>Add Material-Speaking: Descripbe Image | Origin Overseas - PTE tutors </title>
        ...
        if (in_array($fileActualExt,$allowed)){
            if ($fileError === 0 ){
                if ($fileSize <  8388608999){
                    ...
                    $sql = mysqli_query($conn, "INSERT INTO material_speaking(type, image, answer, modify_date) VALUES ('$type', '$fileNameNew', '$answer', '$modify_date') ");
                    if ($sql == true) {
                        ...
                        ?>
                        <script type="text/javascript">    
                        window.location = "speaking_describe_image.php?error=1";
                        </script>
                        <?php
                    }
                    ...
                    ?>
                    <script type="text/javascript">
                    window.location = "speaking_describe_image.php?high=1";
                    </script>
                    <?php
                }
            }else{
                    ?>
                    <script type="text/javascript">      
                    window.location = "speaking_describe_image.php?file_error=1";
                    </script>
                    <?php
            }
        }else{
            ?>
            <script type="text/javascript">
            window.location = "speaking_describe_image.php?type=1"; 
            </script>
            <?php
        }
    }
