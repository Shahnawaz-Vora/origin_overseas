...
<head>
    ...
    <title>Add Material-Reading: Multiple-choice, choose single answer | Origin Overseas - PTE tutors </title>
                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="../add_material.php">Add Material</a></li>
                                   ...
                                   <div class="row">
                                    <div class="col-md-11 mx-auto">
                                        <div class="form-group" align="center">
                                            <button class="btn btn-primary btn-rounded" name="submit" id="submit" type="submit" style="width: 110px;margin-top: -30px;font-family: sans-serif;letter-spacing: 1.7px;margin-bottom: 15px">SUBMIT</button>
                                        </div>
                                    </div>
                                 </div>
                            </form>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($tot_options != $options) {
            ?>
            <script type="text/javascript">    
            window.location.href = "reading_single_answer.php?missing=1";
            </script>
            <?php
        }
        ...
        if ($answer == null || $answer == "")
        {
            ...
            $sql = mysqli_query($conn, "INSERT INTO material_reading(type, answer, question, questionText, option1, option2, option3, option4, option5, option6, option7, option8, modify_date) VALUES ('$type', '$answer','$question', '$question_text', '$option[0]', '$option[1]', '$option[2]', '$option[3]', '$option[4]', '$option[5]', '$option[6]', '$option[7]', '$modify_date') ");
            if ($sql == true) {
                ...
                ?>
                <script type="text/javascript">    
                window.location = "reading_single_answer.php?error=1";
                </script>
                <?php
            }
        }
