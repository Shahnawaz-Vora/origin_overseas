...
<head>
    ...
    <title>Add Material-Listening: Summarize Spoken Text | Origin Overseas - PTE tutors </title>
        ...
        if (in_array($fileActualExt,$allowed)){
            if ($fileError === 0 ){
                ...
                if ($sql == true) {
                    ...
                    ?>
                    <script type="text/javascript">    
                        window.location = "listening_summarize_spoken_text.php?error=1";
                    </script>
                    <?php
                }
            }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "listening_summarize_spoken_text.php?file_error=1";
                    </script>
                    <?php
            }
        }else{
            ?>
            <script type="text/javascript">
            window.location = "listening_summarize_spoken_text.php?type=1"; 
            </script>
            <?php
        }
    }
