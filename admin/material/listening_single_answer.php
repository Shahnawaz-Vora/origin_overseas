...
<head>
    ...
    <title>Add Material-Listening: Multiple choice, choose single answers | Origin Overseas - PTE tutors </title>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($tot_options != $options) {
            ...
            window.location = "listening_single_answer.php";
            </script>
            <?php
        }
        ...
        if (in_array($fileActualExt,$allowed)){
            if ($fileError === 0 ){
                if ($fileSize <  8388608999){
                    ...
                    $sql = mysqli_query($conn, "INSERT INTO material_listening(type, audio, answer, transcript, question, option1, option2, option3, option4, option5, option6, option7, option8, modify_date) VALUES ('$type', '$fileNameNew', '$answer', '$transcript', '$question', '$option[0]', '$option[1]', '$option[2]', '$option[3]', '$option[4]', '$option[5]', '$option[6]', '$option[7]', '$modify_date') ");
                    if ($sql == true) {
                        ...
                        ?>
                        <script type="text/javascript">    
                        window.location = "listening_single_answer.php?error=1";
                        </script>
                        <?php
                    }
                }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "listening_single_answer.php?high=1";
                    </script>
                    <?php
                }
            }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "listening_single_answer.php?file_error=1";
                    </script>
                    <?php
            }
        }else{
            ?>
            <script type="text/javascript">
            window.location = "listening_single_answer.php?type=1"; 
            </script>
            <?php
        }
    }
