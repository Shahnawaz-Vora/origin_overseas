...
<head>
    ...
    <title>Add Material-Reading: Reorder Paragraph | Origin Overseas - PTE tutors </title>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($tot_options != $options) {
            ?>
            <script type="text/javascript">    
            window.location.href = "reading_reorder_paragraph.php&missing=1";
            </script>
            <?php
        }
        else{
            $sql = mysqli_query($conn, "INSERT INTO material_reading(type,answer,option1, option2, option3, option4, option5, option6, option7, option8, modify_date) VALUES ('$type','$answer','$option[0]', '$option[1]', '$option[2]', '$option[3]', '$option[4]', '$option[5]', '$option[6]', '$option[7]', '$modify_date') ");
            if ($sql == true) {
                ?>
                <script type="text/javascript">    
                ...
                ?>
                <script type="text/javascript">    
                window.location = "reading_reorder_paragraph.php?error=1";
                </script>
                <?php
            }
        }              
