...
<head>
    ...
    <title>Add Material-Listening: Select Missing Word | Origin Overseas - PTE tutors </title>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($tot_options != $options) {
            ...
            window.location = "listening_select_missing_word.php";
            </script>
            <?php
        }
        $answer = $option[$radio];
        ...
        if (in_array($fileActualExt,$allowed)){
            if ($fileError === 0 ){
                if ($fileSize <  8388608999999){
                    ...
                    $sql = mysqli_query($conn, "INSERT INTO material_listening(type, audio, answer, transcript, option1, option2, option3, option4, option5, option6, option7, option8, modify_date) VALUES ('$type', '$fileNameNew', '$answer', '$transcript', '$option[0]', '$option[1]', '$option[2]', '$option[3]', '$option[4]', '$option[5]', '$option[6]', '$option[7]', '$modify_date') ");
                    if ($sql == true) {
                        ...
                        ?>
                        <script type="text/javascript">    
                        window.location = "listening_select_missing_word.php?error=1";
                        </script>
                        <?php
                    }
                }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "listening_select_missing_word.php?high=1";
                    </script>
                    <?php
                }
            }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "listening_select_missing_word.php?file_error=1";
                    </script>
                    <?php
            }
        }else{
            ?>
            <script type="text/javascript">
            window.location = "listening_select_missing_word.php?type=1"; 
            </script>
            <?php
        }
    }
