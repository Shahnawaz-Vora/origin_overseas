...
<head>
    ...
    <title>Add Material-Listening: Highlight Correct Summary | Origin Overseas - PTE tutors </title>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($tot_options != $options) {
            ...
            window.location = "listening_highlight_correct_summary.php";
            </script>
            <?php
        }
        $answer = $option[$radio];
        ...
        if (in_array($fileActualExt,$allowed)){
            if ($fileError === 0 ){
                if ($fileSize <  8388608999999){
                    ...
                    $sql = mysqli_query($conn, "INSERT INTO material_listening(type, audio, answer, transcript, questionText, option1, option2, option3, option4, option5, option6, option7, option8, modify_date) VALUES ('$type', '$fileNameNew', '$answer', '$transcript', '$question_text', '$option[0]', '$option[1]', '$option[2]', '$option[3]', '$option[4]', '$option[5]', '$option[6]', '$option[7]', '$modify_date') ");
                    if ($sql == true) {
                        ...
                        ?>
                        <script type="text/javascript">    
                        window.location = "listening_highlight_correct_summary.php?error=1";
                        </script>
                        <?php
                    }
                }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "listening_highlight_correct_summary.php?high=1";
                    </script>
                    <?php
                }
            }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "listening_highlight_correct_summary.php?file_error=1";
                    </script>
                    <?php
            }
        }else{
            ?>
            <script type="text/javascript">
            window.location = "listening_highlight_correct_summary.php?type=1"; 
            </script>
            <?php
        }
    }
