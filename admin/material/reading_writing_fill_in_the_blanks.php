...
<head>
    ...
    <title>Add Material-Reading and Writing: Fill in the Blanks | Origin Overseas - PTE tutors </title>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($sql == true) {
            ...
            ?>
            <script type="text/javascript">    
            window.location = "reading_writing_fill_in_the_blanks.php?error=1";
            </script>
            <?php
        }
    }
