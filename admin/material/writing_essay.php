...
<head>
    ...
    <title>Add Material-Writing: Essay Writing | Origin Overseas - PTE tutors </title>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($conn, "INSERT INTO material_writing (type, answer, questionText, modify_date) VALUES('$type', '$answer', '$question_text', '$modify_date') ");
        if ($sql == true) {
            ?>
            ...
            window.location = "writing_essay.php?error=1";
            </script>
            <?php
        }
    }
