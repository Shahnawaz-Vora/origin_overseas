...
<?php 
    ...
    if(isset($_GET['question']) && isset($_GET['student_id']) && isset($_GET['test_no']))
    {
        ...
        $q= 4;
        $user_sql = mysqli_query($conn , "SELECT * from section_user_test WHERE studentId='$studentId' AND test_no='$test_no' AND section='writing' AND type='essay' AND question_no='$q' ");
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a href="../evaluation_section_test_table.php?testno=<?php echo $test_no; ?>&student_id=<?php echo $studentId; ?>&type=essay&section=writing"><?php echo $row5['test_name']; ?> :Essay</a></li>
...
if(isset($_POST['update']))
{
    ...
    if($sql == true)
    {
        ?><script>location.replace("../evaluation_section_test_table.php?student_id=<?php echo $studentId; ?>&testno=<?php echo $test_no; ?>&insert=1&type=essay&section=writing");</script><?php
    }
    else
    {
