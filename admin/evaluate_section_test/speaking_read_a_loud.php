                ...
                <li>
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item" aria-current="page"><a href="../secetion_test_evaluation_table.php">Evaluate Tests</a></li>
                                <li class="breadcrumb-item" aria-current="page"><a href="../evaluation_section_test_table.php?testno=<?php echo $test_no; ?>&student_id=<?php echo $studentId; ?>&type=read-aloud&section=speaking"><?php echo $row5['test_name']; ?> :Read A Loud</a></li>
...
if(isset($_POST['update_next']))
{
    ...
    $sql = mysqli_query($conn,"UPDATE section_user_test set marks='$marks',content='$content',fluency='$fluency',pronunciation='$pronounciation',comments='$comments' where studentId='$studentId' and test_no='$test_no' and question_no='$question_no'");
    if($sql == true)
    {
        if($question_no == 7)
        {
...
if(isset($_POST['update']))
{
    ...
    if($sql == true)
    {
        ?><script>location.replace("../evaluation_section_test_table.php?student_id=<?php echo $studentId; ?>&testno=<?php echo $test_no; ?>&insert=1&type=read-aloud&section=speaking");</script><?php
    }
    else
    {
        ?><script>location.replace("speaking_read_a_loud.php?question=<?php echo $id ; ?>&student_id=<?php echo $studentId; ?>&test_no=<?php echo $test_no; ?>&error=1");</script><?php
