...
<?php 
    ...
    if(isset($_GET['question']) && isset($_GET['student_id']) && isset($_GET['test_no']))
    {
        ...
        $q=$question_no+7;
        $user_sql = mysqli_query($conn , "SELECT * from section_user_test WHERE studentId='$studentId' AND test_no='$test_no' AND section='speaking' AND type='repeat-sentence' AND question_no='$q' ");
...
<head>
    ...
    <title>Evaluate Test-Speaking: Repeat Sentence | Origin Overseas - PTE tutors </title>
...
<body>
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a href="../evaluation_section_test_table.php?testno=<?php echo $test_no; ?>&student_id=<?php echo $studentId; ?>&type=repeat-sentence&section=speaking"><?php echo $row5['test_name']; ?> :Repeat Sentence</a></li>
                                        ...
                                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 layout-top-spacing">
                                                    <h4><center><b>Repeat Sentence</b> : Question <?php echo $question_no; ?></center></h4>
                                                    <div class="info">
                                                        <div class="row">
                                                            ...
                                                            <div class="row no-gutters" style="margin-top: -45px;margin-left: 40px;">
                                                                ...
                                                                <div class="col-md-2 mx-auto no-gutters" >
                                                                    ...
                                                                    <label style="font-size:1em">Pronounciation: </label>
                                                                        ...
                                                                        <span id="content_pro" style="color: red;display: none;">Marks must be 0 to 3</span>
                                                                    </div>
                                                                </div>
    ...
    <script>
        ...
        function calculate(){
            ...
            if(parseInt(pronounciation) >=0 && parseInt(pronounciation)<=3){
...
if(isset($_POST['update_next']))
{
    ...
    if($sql == true)
    {
        if($question_no == 10)
        {
            $id = $id+1;
            ?><script>
                location.replace("speaking_describe_image.php?question=<?php echo $id; ?>&student_id=<?php echo $studentId; ?>&test_no=<?php echo $test_no; ?>");
            </script><?php
        }
        else
        {
    ...
    {
        ?><script>location.replace("speaking_repeat_sentence.php?question=<?php echo $id ; ?>&student_id=<?php echo $studentId; ?>&test_no=<?php echo $test_no; ?>&error=1");</script><?php
    }
}
if(isset($_POST['update']))
{
    ...
    if($sql == true)
    {
        ?><script>location.replace("../evaluation_section_test_table.php?student_id=<?php echo $studentId; ?>&testno=<?php echo $test_no; ?>&insert=1&type=repeat-sentence");</script><?php
    }
    else
    {
        ?><script>location.replace("speaking_repeat_sentence.php?question=<?php echo $id ; ?>&student_id=<?php echo $studentId; ?>&test_no=<?php echo $test_no; ?>&error=1");</script><?php
