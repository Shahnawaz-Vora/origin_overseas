...
<?php 
    ...
    if(isset($_GET['question']) && isset($_GET['student_id']) && isset($_GET['test_no']))
    {
        ...
        $q=$question_no+24;
        $user_sql = mysqli_query($conn , "SELECT * from section_user_test WHERE studentId='$studentId' AND test_no='$test_no' AND section='speaking' AND type='re-tell-lecture' AND question_no='$q' ");
...
<head>
    ...
    <title>Evaluate Test-Speaking: Re Tell Lacture | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a href="../evaluation_section_test_table.php?testno=<?php echo $test_no; ?>&student_id=<?php echo $studentId; ?>&type=re-tell-lecture&section=speaking"><?php echo $row5['test_name']; ?> :Re-Tell Lecture</a></li>
                                                                            ...
                                                                            <?php 
                                                                                if(file_exists("../../database/audio/".$row['audio']) || file_exists("../../database/video/".$row['audio']))
                                                                                {
                                                                                    ...
                                                                                    if(file_exists("../../database/video/".$row['audio'])){
                                                                                        echo "<video controls width=150% id='imgshow' src=../../database/video/".$row['audio']."></video><br><br>";  $audio_video = 1;    
                                                                                    }
                                                                                }
                                                                            ?>
                                                                        </div>
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing" style="margin-top: -65px">
                                                    ...
                                                    <div class="info" style="margin-top: -15px" disabled=true;>
                                                        ...
                                                        <div class="row" style="margin-top: -45px">
                                                            <div class="col-md-11 mx-auto" align="center">
                                                                <div class="form-group">
                                                                    <input readonly="" style="color:black;" class="form-control" required="" id="marks" name="marks" value="<?php if (isset($user_row['marks'])) {echo $user_row['marks']; } else {echo ""; } ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
if(isset($_POST['update_next']))
{
    ...
    $sql = mysqli_query($conn,"update section_user_test set marks='$marks',content='$content',fluency='$fluency',pronunciation='$pronounciation',comments='$comments' where studentId='$studentId' and test_no='$test_no' and question_no='$q' ");
    if($sql == true)
    {
        if($question_no == 4)
        {
            $id = $id+1;
            ?><script>location.replace("speaking_short_question.php?question=<?php echo $id; ?>&student_id=<?php echo $studentId; ?>&test_no=<?php echo $test_no; ?>");</script><?php
        }
        else
        {
            $id = $id+1;
            ?><script>
                location.replace("speaking_re_tell_lecture.php?question=<?php echo $id; ?>&student_id=<?php echo $studentId; ?>&test_no=<?php echo $test_no; ?>");
            </script><?php
        }
    }
    else
    {
        ?><script>location.replace("speaking_re_tell_lecture.php?question=<?php echo $id ; ?>&student_id=<?php echo $studentId; ?>&test_no=<?php echo $test_no; ?>&error=1");</script><?php
    }
}
if(isset($_POST['update']))
{
    ...
    if($sql == true)
    {
        ?><script>location.replace("../evaluation_section_test_table.php?student_id=<?php echo $studentId; ?>&testno=<?php echo $test_no; ?>&insert=1&type=re-tell-lecture&section=speaking");</script><?php
    }
    else
    {
        ?><script>location.replace("speaking_re_tell_lecture.php?question=<?php echo $id ; ?>&student_id=<?php echo $studentId; ?>&test_no=<?php echo $test_no; ?>&error=1");</script><?php
