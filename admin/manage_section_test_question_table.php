...
<body>
    ...
    function editQuestion(id,section){
        if (section == "speaking") {
        	if (type == "answer-short-question") {
        		location.replace("update_section_test/speaking_short_question.php?question="+id);
        	}
        	else if (type == "read-aloud") {
        		location.replace("update_section_test/speaking_read_a_loud.php?question="+id);
        	}else if (type == "repeat-sentence") {
        		location.replace("update_section_test/speaking_repeat_sentence.php?question="+id);
    	    }else if (type == "describe-image") {
    	        location.replace("update_section_test/speaking_describe_image.php?question="+id);
    	    }else if (type == "re-tell-lecture") {
    	    	location.replace("update_section_test/speaking_re_tell_lecture.php?question="+id);
            }
        }else if (section == "writing") {
    	    if (type == "summarize-written-text") {
    	    	location.replace("update_section_test/writing_written_text.php?question="+id);
    	    }else if (type == "essay") {
    	    	location.replace("update_section_test/writing_essay.php?question="+id);
            }
        }else if (section == "reading") {
    	    if (type == "single-answer") {
    			location.replace("update_section_test/reading_single_answer.php?question="+id);    	
    	    }else if (type == "multiple-answers") {
    	    	location.replace("update_section_test/reading_multiple_answer.php?question="+id);
    	    }else if (type == "reorder-paragraph") {
    	    	location.replace("update_section_test/reading_reorder_paragraph.php?question="+id);
    	    }else if (type == "fill-in-the-blanks") {
    	    	location.replace("update_section_test/reading_fill_in_the_blanks.php?question="+id);
    	    }else if (type == "reading-and-writing-fill-in-the-blanks") {
    	    	location.replace("update_section_test/reading_writing_fill_in_the_blanks.php?question="+id);
            }
        }else if (section == "listening") {
    	    if (type == "summarize-spoken-text") {
    	    	location.replace("update_section_test/listening_summarize_spoken_text.php?question="+id);
    	    }else if (type == "multiple-answers") {
    	    	location.replace("update_section_test/listening_multiple_answer.php?question="+id);
    	    }else if (type == "fill-in-the-blanks") {
    	    	location.replace("update_section_test/listening_fill_in_the_blanks.php?question="+id);
    	    }else if (type == "highlight-correct-summary") {
    	    	location.replace("update_section_test/listening_highlight_correct_summary.php?question="+id);
    	    }else if (type == "single-answer") {
    	    	location.replace("update_section_test/listening_single_answer.php?question="+id);
    	    }else if (type == "select-missing-word") {
    	    	location.replace("update_section_test/listening_select_missing_word.php?question="+id);
    	    }else if (type == "highlight-incorrect-words") {
    	    	location.replace("update_section_test/listening_highlight_incorrect_words.php?question="+id);
    	    }else if (type == "write-from-dictation") {
    	    	location.replace("update_section_test/listening_write_from_dictation.php?question="+id);
    	    }
        }
    }
    </script> 
...
if (isset($_POST['delete'])) {
        ...
        $sql = mysqli_query($conn,"DELETE FROM section_test WHERE test_no='$test_no' and type='$type' and id='$id'");
        if ($sql == false) {
            ?>   
            <script type="text/javascript">    
            ...
            $sql = mysqli_query($conn , "update manage_section_test set status=0 , total_question_entered=total_question_entered-1 where test_no='$test_no'");
            ?>
            <script type="text/javascript">    
            window.location = "<?php $_SERVER['REQUEST_URI'] ?>";
            r = false;
