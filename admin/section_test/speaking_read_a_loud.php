...
<?php
    if (isset($_POST['submit'])) {
        ...
        $modify_date = date("Y/m/d");
        $question_no = $_GET['question_no'];
        $sql = "INSERT INTO `section_test`(`test_no`,`question_no`,`type`,`questionText`,`answer`,`modify_date`,`section`) VALUES ('$test_no','$question_no','$type','$question_text','$answer','$modify_date','$section')";
