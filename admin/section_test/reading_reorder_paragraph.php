...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($tot_options != $options) {
            ...
            $sql = mysqli_query($conn, "INSERT INTO section_test(test_no,question_no,type,answer,option1, option2, option3, option4, option5, option6, option7, option8, modify_date,section) VALUES ('$test_no','$question_no','$type','$answer','$option[0]', '$option[1]', '$option[2]', '$option[3]', '$option[4]', '$option[5]', '$option[6]', '$option[7]', '$modify_date','$section')");
            if ($sql == true) {
