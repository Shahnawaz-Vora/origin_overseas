...
<head>
    ...
    <title>Create Test-Speaking: Describe Image | Origin Overseas - PTE tutors </title>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-2 col-lg-12 col-md-4">
                                                                    <div class="upload mt-4 pr-md-4" style="border:none">
                                                                        ...
                                                                        <p class="mt-2"><i class="flaticon-cloud-upload mr-1"></i><b style="color: red"> Upload Image</b></p>
                                                                    </div>
                                                                </div>
        ...
        if (in_array($fileActualExt,$allowed)){
            if ($fileError === 0 ){
                if ($fileSize <  8388608999){
                    ...
                    $sql = mysqli_query($conn, "INSERT INTO `section_test`(`test_no`,`question_no`,`type`,`image`,`answer`,`modify_date`,`section`) VALUES ('$test_no','$question_no','$type','$fileNameNew','$answer','$modify_date','$section')");
                    if ($sql == true) {
                        ...
                        if($question_no <= 7)
                        {
                            ?><script>location.replace("speaking_describe_image.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no ?>&question=success");</script><?php
                        }
                        else
                        { 
                            ?><script>location.replace("speaking_re_tell_lecture.php?testno=<?php echo $test_no; ?>&question_no=1&question=success");</script><?php    
                        }
                    }
                    else
                    {
                        ?><script type="text/javascript">location.href = "speaking_describe_image.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&error=1";</script><?php
                    }
                }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "speaking_describe_image.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&high=1";
                    </script>
                    <?php
                }
            }else{
                    ?>
                    <script type="text/javascript">      
                    window.location = "speaking_describe_image.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&file_error=1";
                    </script>
                    <?php
            }
        }else{
            ?>
            <script type="text/javascript">
            window.location = "speaking_describe_image.php?testno=<?php echo $test_no; ?>&question_no=<?php echo $question_no;?>&type=1"; 
            </script>
            <?php
        }
    }
