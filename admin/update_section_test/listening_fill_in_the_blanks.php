...
<?php
    if (isset($_POST['submit'])) {
        ...
        if(isset($_FILES['profileImg'])){
            ...
            if (in_array($fileActualExt,$allowed)){
                if ($fileError === 0 ){
                    if ($fileSize <  8388608999){
                        ...
                        $sql = mysqli_query($conn, "update test set audio='$fileNameNew',transcript='$transcript',questionText='$question_text_replaced', option1='$option[0]', option2='$option[1]', option3='$option[2]', option4='$option[3]', option5='$option[4]', option6='$option[5]', option7='$option[6]', option8='$option[7]', modify_date='$modify_date' where id='$id'");
                        if ($sql == true) {
            ...
            $sql = mysqli_query($conn, "update test set transcript='$transcript',questionText='$question_text_replaced', option1='$option[0]', option2='$option[1]', option3='$option[2]', option4='$option[3]', option5='$option[4]', option6='$option[5]', option7='$option[6]', option8='$option[7]', modify_date='$modify_date' where id='$id'");
            if ($sql == true) {
                ?>
                <script type="text/javascript">    
                window.location = "../manage_section_test_question_table.php?section=listening&testno=<?php echo $test_no; ?>&type=<?php echo $type; ?>&update=success"; 
