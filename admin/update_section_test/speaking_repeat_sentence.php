...
<head>
    ...
    <title>Update Test-Speaking: Repeat Sentence | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="../manage_section_test_question_table.php?section=speaking&testno=<?php echo $t; ?>&type=repeat-sentence">Speaking: Repeat Sentence</a></li>
