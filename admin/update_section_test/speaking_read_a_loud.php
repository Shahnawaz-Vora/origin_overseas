...
<head>
    ...
    <title>Update Test-Speaking: Read Aloud | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="../manage_section_test_question_table.php?section=speaking&testno=<?php echo $t; ?>&type=read-aloud">Speaking: Read A Loud</a></li>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($conn, "update section_test set questionText='$question_text', answer='$answer',modify_date='$modify_date' where id='$id'");
        if ($sql == true) {
            ?>
            ...
            ?>
            <script type="text/javascript">    
            location.replace("speaking_read_a_loud.php?question=<?php echo $id ?>&error=1");
            </script>
            <?php
        }
