...
<?php
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($conn, "update test set answer='$answer',questionText='$question_text_replaced', option1='$option[0]', option2='$option[1]', option3='$option[2]', option4='$option[3]', option5='$option[4]', option6='$option[5]', option7='$option[6]', option8='$option[7]', modify_date='$modify_date' where id='$id'");
        if ($sql == true) {
            ?>
                <script type="text/javascript"> 
