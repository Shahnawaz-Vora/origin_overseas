...
<head>
    ...
    <title>Update Test-Speaking: Answer Short Quesrion | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="../manage_section_test_question_table.php?section=speaking&testno=<?php echo $t; ?>&type=answer-short-question">Speaking: Answer Short Question</a></li>
            ...
            if (in_array($fileActualExt,$allowed)){
                if ($fileError === 0 ){
                    if ($fileSize <  8388608999){
                        ...
                        $sql = mysqli_query($conn, "update section_test set audio='$fileNameNew' , answer='$answer',transcript='$transcript',modify_date='$modify_date' where id='$id'");
                        if ($sql == true) {
                            ...
                            ?>
                            <script type="text/javascript">    
                            location.replace("speaking_short_question.php?question=<?php echo $id ?>&error=1");
                            </script>
                            <?php
                        }
                    }else{
                        ?>
                        <script type="text/javascript">
                        location.replace("speaking_short_question.php?question=<?php echo $id ?>&high=1");
                        </script>
                        <?php
                    }
                }else{
                        ?>
                        <script type="text/javascript">
                        location.replace("speaking_short_question.php?question=<?php echo $id ?>&file_error=1");
                        </script>
                        <?php
                }
            }else{
                ?>
                <script type="text/javascript">
                location.replace("speaking_short_question.php?question=<?php echo $id ?>&type=1"); 
                </script>
                <?php
            }
        }else{
