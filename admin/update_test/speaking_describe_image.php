                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="../manage_test_question_table.php?section=speaking&testno=<?php echo $t; ?>&type=describe-image">Speaking: Describe Image</a></li>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if(isset($_FILES['profileImg'])){
            if (in_array($fileActualExt,$allowed)){
                if ($fileError === 0 ){
                    if ($fileSize <  8388608999){
                        ...
                        $sql = mysqli_query($conn, "update test set image='$fileNameNew' , answer='$answer',modify_date='$modify_date' where id='$id'");
                        if ($sql == true) {
            ...
            $sql = mysqli_query($conn, "update test set answer='$answer',modify_date='$modify_date' where id='$id'");
            if ($sql == true) {
                ?>
                <script type="text/javascript">    
                window.location = "../manage_test_question_table.php?section=speaking&testno=<?php echo $test_no; ?>&type=<?php echo $type; ?>&update=success";   
