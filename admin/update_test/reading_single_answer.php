...
<head>
    ...
    <title>Update Test-Reading: Multiple-choice, choose single answer | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="../manage_section_test_question_table.php?section=reading&testno=<?php echo $t; ?>&type=single-answer">Reading: Single Answer</a></li>
                                        ...
                                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 layout-top-spacing">
                                                    <h4><center><b>Multiple-choice, choose single answer</b> : Question <?php echo $question_no; ?></center></h4>
                                                    <div class="info">
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($tot_options != $options) {
            ?>
            <script type="text/javascript">    
            window.location.href = "reading_single_answer.php?question=<?php echo $id ?>&missing=1";
            </script>
            <?php
        }
        ...
        if ($answer == null || $answer == "")
        {
            ...
            $sql = mysqli_query($conn, "update section_test set answer='$answer',question='$question', questionText='$question_text', option1='$option[0]', option2='$option[1]', option3='$option[2]', option4='$option[3]', option5='$option[4]', option6='$option[5]', option7='$option[6]', option8='$option[7]', modify_date='$modify_date' where id='$id'");
            if ($sql == true) {
            ?>
                <script type="text/javascript"> 
            ...
            <?php    
                ...
                ?>
                <script type="text/javascript">    
                window.location = "reading_single_answer.php?question=<?php echo $id ?>&error=1";
                </script>
                <?php
            }
        }
