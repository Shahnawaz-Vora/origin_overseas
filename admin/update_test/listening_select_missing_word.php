...
<head>
    ...
    <title>Update Test-Listening: Select Missing Word | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="../manage_section_test_question_table.php?section=listening&testno=<?php echo $t; ?>&type=select-missing-word">Listening: Select Missing Word</a></li>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($tot_options != $options) {
            ?>
            <script type="text/javascript">    
            window.location = "listening_select_missing_word.php?question=<?php echo $id ?>&missing=1";
            </script>
            <?php
        }
        $answer = $option[$radio];
            ...
            if (in_array($fileActualExt,$allowed)){
                if ($fileError === 0 ){
                    if ($fileSize <  8388608999999){
                        ...
                        $sql = mysqli_query($conn, "update section_test set audio='$fileNameNew', answer='$answer',transcript='$transcript', option1='$option[0]', option2='$option[1]', option3='$option[2]', option4='$option[3]', option5='$option[4]', option6='$option[5]', option7='$option[6]', option8='$option[7]', modify_date='$modify_date' where id='$id'");
                        if ($sql == true) {
                        ...
                        <?php    
                            ...
                            ?>
                            <script type="text/javascript">    
                            window.location = "listening_select_missing_word.php?question=<?php echo $id ?>&error=1";
                            </script>
                            <?php
                        }
                    }else{
                        ?>
                        <script type="text/javascript">
                        window.location = "listening_select_missing_word.php?question=<?php echo $id ?>&high=1";
                        </script>
                        <?php
                    }
                }else{
                        ?>
                        <script type="text/javascript">
                        window.location = "listening_select_missing_word.php?question=<?php echo $id ?>&file_error=1";
                        </script>
                        <?php
                }
            }else{
                ?>
                <script type="text/javascript">
                window.location = "listening_select_missing_word.php?question=<?php echo $id ?>&type=1"; 
                </script>
                <?php
            }
        }else{
            $sql = mysqli_query($conn, "update section_test set answer='$answer',transcript='$transcript', option1='$option[0]', option2='$option[1]', option3='$option[2]', option4='$option[3]', option5='$option[4]', option6='$option[5]', option7='$option[6]', option8='$option[7]', modify_date='$modify_date' where id='$id'");
            if ($sql == true) {
            ?>
                <script type="text/javascript"> 
                window.location = "../manage_section_test_question_table.php?section=listening&testno=<?php echo $test_no; ?>&type=<?php echo $type; ?>&update=success"; 
