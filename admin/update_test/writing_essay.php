...
<head>
    ...
    <title>Update Test-Writing: Essay Writing | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="../manage_section_test_question_table.php?section=writing&testno=<?php echo $t; ?>&type=essay">Writing: Essay Writing</a></li>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($sql == true) {
            ...
            ?>
            <script type="text/javascript">    
            window.location = "writing_essay.php?question=<?php echo $id ?>&error=1";
            </script>
            <?php
        }
    }
