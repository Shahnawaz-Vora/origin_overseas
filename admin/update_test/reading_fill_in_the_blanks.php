...
<head>
    ...
    <title>Update Test-Reading: Fill in the Blanks | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="../manage_section_test_question_table.php?section=reading&testno=<?php echo $t; ?>&type=fill-in-the-blanks">Reading: Fill in the Blanks</a></li>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($conn, "update section_test set answer='$answer',questionText='$question_text_replaced', option1='$option[0]', option2='$option[1]', option3='$option[2]', option4='$option[3]', option5='$option[4]', option6='$option[5]', option7='$option[6]', option8='$option[7]', modify_date='$modify_date' where id='$id'");
        if ($sql == true) {
            ?>
                <script type="text/javascript"> 
            ...
            ?>
            <script type="text/javascript">    
            window.location = "reading_fill_in_the_blanks.php?question=<?php echo $id ?>&error=1";
            </script>
            <?php
        }   
    }
