...
<head>
    ...
    <title>Update Test-Listening: Summarize Spoken Text | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="../manage_section_test_question_table.php?section=listening&testno=<?php echo $t; ?>&type=summarize-spoken-text">Listening: Summarize Spoken Text</a></li>
            ...
            if (in_array($fileActualExt,$allowed)){
                if ($fileError === 0 ){
                    ...
                    <?php    
                        ...
                        ?>
                        <script type="text/javascript">    
                        window.location = "listening_summarize_spoken_text.php?question=<?php echo $id ?>&error=1";
                        </script>
                        <?php
                    }
                }else{
                        ?>
                        <script type="text/javascript">
                        window.location = "listening_summarize_spoken_text.php?question=<?php echo $id;?>&file_error=1";
                        </script>
                        <?php
                }
            }else{
                ?>
                <script type="text/javascript">
                window.location = "listening_summarize_spoken_text.php?question=<?php echo $id;?>&type=1"; 
                </script>
                <?php
            }
        }else{
