...
<head>
    ...
    <title>Update Test-Reading and Writing: Fill in the Blanks | Origin Overseas - PTE tutors </title>
...
<body>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="../manage_section_test_question_table.php?section=reading&testno=<?php echo $t; ?>&type=reading-and-writing-fill-in-the-blanks">Reading: Reading and Writing Fill in the Blanks</a></li>
    ...
    <script type="text/javascript">
        ...
        function convertSpanToInput() {
            k++;
            $('<div class="d-inline-block" id="'+k+'" contenteditable="false">&lt;span id="replace"&gt;&lt;/span&gt;</div>').insertAfter($(this));
        ...
        var span = $("span[id=replace]").lenght;
...
<?php
    if (isset($_POST['submit'])) {
        ...
        $set   = [];
        for ($i=1; $i<= $options ; $i++) { 
            $f = '<div class=\"d-inline-block\" id=\"'.$i.'\" contenteditable=\"false\">&lt;span id=\"replace\"&gt;&lt;/span&gt;</div>';
            array_push($find, $f);
            array_push($set, '<span id=\"replace\"></span>');    
        }
       
        $question_text_replaced =  trim(str_replace($find, $set, $question_text));
        ...
        $sql = mysqli_query($conn, "UPDATE section_test SET questionText='$question_text_replaced', answer='$answer', option1='$option[0]', option2='$option[1]', option3='$option[2]', option4='$option[3]', option5='$option[4]', option6='$option[5]', option7='$option[6]', option8='$option[7]',  modify_date='$modify_date'  WHERE id='$id' ");
        if ($sql == true) {
            ?>
                <script type="text/javascript"> 
            ...
            ?>
            <script type="text/javascript">    
            window.location = "reading_writing_fill_in_the_blanks.php?question=<?php echo $id ?>&error=1";
            </script>
            <?php
        }
    }
