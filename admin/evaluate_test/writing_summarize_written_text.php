...
<?php 
    ...
    if(isset($_GET['question']) && isset($_GET['student_id']) && isset($_GET['test_no']))
    {
        ...
        $q= $question_no+38;
        $user_sql = mysqli_query($conn , "SELECT * from user_test WHERE studentId='$studentId' AND test_no='$test_no' AND section='writing' AND type='summarize-written-text' AND question_no='$q' ");
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a href="../evaluation_section_table.php?testno=<?php echo $test_no; ?>&student_id=<?php echo $studentId; ?>&type=read-aloud"><?php echo $row5['test_name']; ?> :Summarize Written Text</a></li>
...
if(isset($_POST['update']))
{
    ...
    if($sql == true)
    {
        ?><script>location.replace("../evaluation_section_table.php?student_id=<?php echo $studentId; ?>&testno=<?php echo $test_no; ?>&insert=1&type=summarize-written-text");</script><?php
    }
    else
    {
        ?><script>location.replace("writing_summarize_written_text.php?question=<?php echo $id ; ?>&student_id=<?php echo $studentId; ?>&test_no=<?php echo $test_no; ?>&error=1");</script><?php
