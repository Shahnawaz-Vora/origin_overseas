...
<?php 
    ...
    if(isset($_GET['question']) && isset($_GET['student_id']) && isset($_GET['test_no']))
    {
        ...
        $q= 42;
        $user_sql = mysqli_query($conn , "SELECT * from user_test WHERE studentId='$studentId' AND test_no='$test_no' AND section='writing' AND type='essay' AND question_no='$q' ");
...
<head>
    ...
    <title>Evaluate Test- Writing: Essay | Origin Overseas - PTE tutors </title>
...
<body>
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a href="../evaluation_section_table.php?testno=<?php echo $test_no; ?>&student_id=<?php echo $studentId; ?>&type=read-aloud"><?php echo $row5['test_name']; ?> :Essay</a></li>
                                        ...
                                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 layout-top-spacing" >
                                                    <h4><center><b>Essay</b> : Question <?php echo $question_no; ?></center></h4>
                                                    <div class="info">
                                                        <h6 class="pl-2">
                                                       Question Text:</h6><br>
                                                        ...
                                                        <div class="row no-gutters" style="margin-top: -45px;margin-left: 40px;">
                                                            <div class="col-md-2 mx-auto" align="center">
                                                                <div class="form-group" align="left">
                                                                    ...
                                                                    <span id="content_error" style="color: red;display: none;">Marks must be 0 to 22.5</span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2 mx-auto no-gutters" >
                                                                <div class="form-group" align="left">
                                                                    ...
                                                                    <span id="content_vocabulary" style="color: red;display: none;">Marks must be 0 to 22.5</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2 mx-auto no-gutters" >
                                                                <div class="form-group" align="left">
                                                                    ...
                                                                    <span id="content_grammar" style="color: red;display: none;">Marks must be 0 to 22.5</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2 mx-auto no-gutters" >
                                                                <div class="form-group" align="left">
                                                                    ...
                                                                    <span id="content_spelling" style="color: red;display: none;">Marks must be 0 to 22.5</span>
                                                                </div>
                                                            </div>
    ...
    <script>
        ...
        function calculate(){
            ...
            if(parseFloat(content) >=0 && parseFloat(content)<=22.5){
            ...
            if(parseFloat(vocabulary) >=0 && parseFloat(vocabulary)<=22.5){
            ...
            if(parseFloat(grammar) >=0 && parseFloat(grammar)<=22.5){
            ...
            if(parseFloat(spelling) >=0 && parseFloat(spelling)<=22.5){
...
if(isset($_POST['update']))
{
    ...
    $sql = mysqli_query($conn,"update user_test set marks='$marks',content='$content',vocabulary='$vocabulary',grammar='$grammar',spelling='$spelling',comments='$comments' where studentId='$studentId' and test_no='$test_no' and question_no='$q'");
    if($sql == true)
    {
        ?><script>location.replace("../evaluation_section_table.php?student_id=<?php echo $studentId; ?>&testno=<?php echo $test_no; ?>&insert=1&type=essay");</script><?php
    }
    else
    {
        ?><script>location.replace("writing_essay.php?question=<?php echo $id ; ?>&student_id=<?php echo $studentId; ?>&test_no=<?php echo $test_no; ?>&error=1");</script><?php
    }
}
if(isset($_POST['update_next']))
{
    ...
    if($sql == true)
    {
        ...
        {
            $id = $id+1;
            ?><script>location.replace("listening_summarize_spoken_text.php?question=<?php echo $id; ?>&student_id=<?php echo $studentId; ?>&test_no=<?php echo $test_no; ?>");</script><?php
        }
        else
        {
            $id = $id+1;
            ?><script>
                location.replace("writing_essay.php?question=<?php echo $id; ?>&student_id=<?php echo $studentId; ?>&test_no=<?php echo $test_no; ?>");
            </script><?php
        }
    }
    else
