...
<?php 
    ...
    if(isset($_GET['question']) && isset($_GET['student_id']) && isset($_GET['test_no']))
    {
        ...
        $q=$question_no+24;
        $user_sql = mysqli_query($conn , "SELECT * from user_test WHERE studentId='$studentId' AND test_no='$test_no' AND section='speaking' AND type='re-tell-lecture' AND question_no='$q' ");
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a href="../evaluation_section_table.php?testno=<?php echo $test_no; ?>&student_id=<?php echo $studentId; ?>&type=re-tell-lecture"><?php echo $row5['test_name']; ?> :Re-Tell Lecture</a></li>
...
if(isset($_POST['update_next']))
{
    ...
    $sql = mysqli_query($conn,"update user_test set marks='$marks',content='$content',fluency='$fluency',pronunciation='$pronounciation',comments='$comments' where studentId='$studentId' and test_no='$test_no' and question_no='$q' ");
    if($sql == true)
    {
        if($question_no == 4)
        {
...
if(isset($_POST['update']))
{
    ...
    if($sql == true)
    {
        ?><script>location.replace("../evaluation_section_table.php?student_id=<?php echo $studentId; ?>&testno=<?php echo $test_no; ?>&insert=1&type=re-tell-lecture");</script><?php
    }
    else
    {
        ?><script>location.replace("speaking_re_tell_lecture.php?question=<?php echo $id ; ?>&student_id=<?php echo $studentId; ?>&test_no=<?php echo $test_no; ?>&error=1");</script><?php
