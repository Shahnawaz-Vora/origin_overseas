...
<?php 
    ...
    $section = "writing";
    $sql = mysqli_query($conn,"SELECT * from test where id ='$question_id'");
...
<head>
    ...
    <title>Update Materials-Reading: Single answer | Origin Overseas - PTE tutors </title>
...
<body>
    ...
    <?php
        ...
        include_once '../../database/dbh.inc.php';
        $question_id = $_GET['question'];
        $sql="SELECT * FROM material_reading WHERE type='single-answer' and readingMaterialId='$question_id'";
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Reading: Single Answer</span></li>
                            </ol>
                        </nav>
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                                        ...
                                                        <div class="row" style="margin-top: -45px">
                                                            <div class="col-md-11 mx-auto" align="center">
                                                                <div class="form-group">
                                                                   <textarea rows="4" class="form-control" id="question" name="question" required=""><?php echo stripslashes($row['question']); ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="info" style="margin-top: -15px">
                                                        ...
                                                        <div class="row" style="margin-top: -45px">
                                                            <div class="col-md-11 mx-auto" align="center">
                                                                <div class="form-group">
                                                                   <textarea rows="7" class="form-control" id="question_text" name="question_text" required=""><?php echo stripslashes($row['questionText']); ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option1" >
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="0" id="radio1" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option1']) { echo 'checked=""'; } ?>>
                                                                             <input  name="option1" class="form-control" id="opt1" value="<?php if (isset($row['option1'])) {echo stripslashes($row['option1']);}?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="1" id="radio2" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option2']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <input  name="option2" class="form-control" id="opt2" value="<?php if (isset($row['option2'])) {echo stripslashes($row['option2']);}?>">
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                   ...
                                   <div class="row">
                                    <div class="col-md-11 mx-auto">
                                        <div class="form-group" align="center">
                                            <button class="btn btn-primary btn-rounded" name="submit" id="submit" type="submit" style="width: 110px;margin-top: -30px;font-family: sans-serif;letter-spacing: 1.7px;margin-bottom: 15px">UPDATE</button>
                                        </div>
                                    </div>
                                 </div>
                            </form>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($tot_options != $options) {
            ?>
            <script type="text/javascript">    
            window.location.href = "reading_single_answer.php?question=<?php echo $question_id ?>&missing=1";
            </script>
            <?php
        }
        ...
        if ($answer == null || $answer == "")
        {
            ?>
            <script type="text/javascript">    
            alert("There is missing Answers, Please Try Again");
            window.location.href = "reading_single_answer.php?question=<?php echo $question_id ?>&missing=1";
            </script>
            <?php
        }else{
            
            $sql = mysqli_query($conn, "UPDATE material_reading SET question='$question', questionText='$question_text', answer='$answer', option1='$option[0]', option2='$option[1]', option3='$option[2]', option4='$option[3]', option5='$option[4]', option6='$option[5]', option7='$option[6]', option8='$option[7]',  modify_date='$modify_date'  WHERE readingMaterialId='$question_id' ");
            if ($sql == true) {
                move_uploaded_file($fileTmpName,$fileDestination);
                ?>
                <script type="text/javascript">    
                window.location = "../manage_material_table.php?section=reading&type=single-answer&update=success"; 
                </script>
                <?php    
            }else{
                ?>
                <script type="text/javascript">   
                window.location = "reading_single_answer.php?question=<?php echo $question_id ?>&error=1";
                </script>
                <?php
            }
        }
