...
<head>
    ...
    <title>Update Materials-Listening: Multiple choice, choose single answers | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Listening: Single Answers</span></li>
                            </ol>
                        </nav>
                                                        ...
                                                        <div class="row" style="margin-top: -45px">
                                                            <div class="col-md-11 mx-auto" align="center">
                                                                <div class="form-group">
                                                                    <textarea rows="3" cols="108" class="form-control" id="question_text" name="question" required=""><?php echo stripslashes($row['question']); ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option1" >
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="0" id="radio1" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option1']) { echo 'checked=""'; } ?>> 
                                                                             <input name="option1" class="form-control" id="opt1" value="<?php if (isset($row['option1'])) {echo stripcslashes($row['option1']);}?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="1" id="radio2" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option2']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <input name="option2" class="form-control" id="opt2" value="<?php if (isset($row['option2'])) {echo stripcslashes($row['option2']);}?>">
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="2" id="radio3" class="mr-4 form-control" style="width: 25px;box-shadow: none;">
                                                                             ...
                                                                             <input name="option3" class="form-control" id="opt3" value="<?php if (isset($row['option3'])) {echo stripcslashes($row['option3']);}?>">
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="3" id="radio4" class="mr-4 form-control" style="width: 25px;box-shadow: none;"  <?php if ($row['answer'] == $row['option4']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <input name="option4" class="form-control" id="opt4" value="<?php if (isset($row['option4'])) {echo stripcslashes($row['option4']);}?>">
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option5">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="4" id="radio5" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option5']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <input name="option5" class="form-control" id="opt5" value="<?php if (isset($row['option5'])) {echo stripcslashes($row['option5']);}?>">
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="5" id="radio6" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option6']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <input name="option6" class="form-control" id="opt6" value="<?php if (isset($row['option6'])) {echo stripcslashes($row['option6']);}?>">
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option7">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="6" id="radio7" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option7']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <input name="option7" class="form-control" id="opt7" value="<?php if (isset($row['option7'])) {echo stripcslashes($row['option7']);}?>">
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option8">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="7" id="radio8" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option8']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <input name="option8" class="form-control" id="opt8" value="<?php if (isset($row['option8'])) {echo stripcslashes($row['option8']);}?>">
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($tot_options != $options) {
            ?>
            <script type="text/javascript">    
            window.location = "listening_select_missing_word.php?question=<?php echo $question_id ?>&missing=1";
            </script>
            <?php
        }
        $answer = trim(addslashes($option[$radio]));
            ...
            if (in_array($fileActualExt,$allowed)){
                if ($fileError === 0 ){
                    if ($fileSize <  8388608999){
                        ...
                        $sql = mysqli_query($conn, "UPDATE `material_listening` SET `answer`='$answer',`question`='$question',`option1`='$option[0]',`option2`='$option[1]',`option3`='$option[2]',`option4`='$option[3]',`option5`='$option[4]',`option6`='$option[5]',`option7`='$option[6]',`option8`='$option[7]',`audio`='$fileNameNew',`transcript`='$transcript',`modify_date`='$modify_date' WHERE `listeningMaterialId`='$question_id'");
                        if ($sql == true) {
                            move_uploaded_file($fileTmpName,$fileDestination);
                            unlink("../../database/audio/".$originalfile);
                            ?>
                            <script type="text/javascript">    
                            window.location = "window.location = "../manage_material_table.php?section=listening&type=single-answer&update=success"; 
                            </script>
                            <?php    
                        }else{
                            ?>
                            <script type="text/javascript">    
                            window.location = "listening_select_missing_word.php?question=<?php echo $question_id ?>&error=1";
                            </script>
                            <?php
                        }
                    }else{
                        ?>
                        <script type="text/javascript">
                        window.location = "listening_select_missing_word.php?question=<?php echo $question_id ?>&high=1";
                        </script>
                        <?php
                    }
                }else{
                        ?>
                        <script type="text/javascript">
                        window.location = "listening_select_missing_word.php?question=<?php echo $question_id ?>&file_error=1";
                        </script>
                        <?php
                }
            }else{
                ?>
                <script type="text/javascript">
                window.location = "listening_select_missing_word.php?question=<?php echo $question_id ?>&type=1"; 
                </script>
                <?php
            }
        }else{
            $sql = mysqli_query($conn, "UPDATE `material_listening` SET `answer`='$answer',`question`='$question',`option1`='$option[0]',`option2`='$option[1]',`option3`='$option[2]',`option4`='$option[3]',`option5`='$option[4]',`option6`='$option[5]',`option7`='$option[6]',`option8`='$option[7]',`transcript`='$transcript',`modify_date`='$modify_date' WHERE `listeningMaterialId`='$question_id'");
            if ($sql == true) {
                ?>
                <script type="text/javascript">    
                window.location = "window.location = "../manage_material_table.php?section=listening&type=single-answer&update=success"; 
