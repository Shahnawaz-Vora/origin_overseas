...
<head>
    ...
    <title>Update Materials-Listening: Highlight Correct Summary | Origin Overseas - PTE tutors </title>
                                 ...
                                 <div class="row">
                                    <div class="col-md-11 mx-auto">
                                        <div class="form-group" align="center">
                                             <button class="btn btn-danger form-control" name="submit" type="submit" style="width: 100px;padding: -20px;padding-bottom:5px;height: 35px;margin-top: -58px;">UPDATE</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($tot_options != $options) {
            ?>
            <script type="text/javascript">    
            window.location = "listening_highlight_correct_summary.php?question=<?php echo $question_id ?>&missing=1";
            </script>
            <?php
        }
        $answer = $option[$radio];
        ...
        if(isset($_FILES['profileImg'])){
            ...
            if (in_array($fileActualExt,$allowed)){
                if ($fileError === 0 ){
                    if ($fileSize <  8388608999999){
                        ...
                        if ($sql == true) {
                            ...
                            ?>
                            <script type="text/javascript">    
                            window.location = "../manage_material_table.php?section=listening&type=highlight-correct-summary$update=success"; 
                            </script>
                            <?php    
                        }else{
                            ?>
                            <script type="text/javascript">    
                            window.location = "listening_highlight_correct_summary.php?question=<?php echo $question_id ?>&error=1";
                            </script>
                            <?php
                        }
                    }else{
                        ?>
                        <script type="text/javascript">
                        window.location = "listening_highlight_correct_summary.php?question=<?php echo $question_id ?>&high=1";
                        </script>
                        <?php
                    }
                }else{
                        ?>
                        <script type="text/javascript">
                        window.location = "listening_highlight_correct_summary.php?question=<?php echo $question_id ?>&file_error=1";
                        </script>
                        <?php
                }
            }else{
                ?>
                <script type="text/javascript">
                window.location = "listening_highlight_correct_summary.php?question=<?php echo $question_id ?>&type=1"; 
                </script>
                <?php
            }
        }else{
