...
<head>
    ...
    <title>Update Materials-Writing: Essay Writing | Origin Overseas - PTE tutors </title>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($sql == true) {
            ...
            window.location.href = "../manage_material_table.php?section=writing&type=essay&update=success"; 
            </script>
            <?php    
        }else{
            ?>
