...
<head>
    ...
    <title>Update Materials-Speaking: Re Tell Lacture | Origin Overseas - PTE tutors </title>
                                                                            ...
                                                                            <?php 
                                                                                if(file_exists("../../database/audio/".$row['audio']) || file_exists("../../database/video/".$row['audio']))
                                                                                {
                                                                                    ...
                                                                                    if(file_exists("../../database/video/".$row['audio'])){
                                                                                        echo "<video controls width=150% id='imgshow' src=../../database/video/".$row['audio']."></video>";  $audio_video = 1;    
                                                                                    }
                                                                                }
                                                                                else{
                                                                                        echo '<input type="file" id="profileImg" class="dropify" data-default-file="" data-max-file-size="5M" name="profileImg" accept="audio/* "/ required=""><p class="mt-2"><i class="flaticon-cloud-upload mr-1"></i><b style="color: red"> Upload Audio/Video</b></p>'; 
                                                                                }
                                                                            ?>
                                                                        </div>
            ...
            if (in_array($fileActualExt,$allowed) || in_array($fileActualExt,$allowed_vid)){
                if ($fileError === 0 ){
                    ...
                    if ($sql == true) {
                        ...
                        window.location = "../manage_material_table.php?section=speaking&type=re-tell-lecture&update=success"; 
                        </script>
                        <?php    
                    }else{
                        ?>
