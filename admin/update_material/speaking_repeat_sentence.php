...
<head>
    ...
    <title>Update Materials-Speaking: Repeat Sentence | Origin Overseas - PTE tutors </title>
    ...
    <script>
        ...
        function remove(){
            ...
            $(".uploadimg").append('<input type="file" id="profileImg" class="dropify" data-default-file="" data-max-file-size="5M" name="profileImg" accept="audio/* "/ required=""><p class="mt-2"><i class="flaticon-cloud-upload mr-1"></i><b style="color: red"> Upload Audio</b></p>');
                ...
                // var id = <?php echo $id; ?>;
                // $.ajax({
                //      url: 'deletefile.php?speakingid='+id+'&file=audio',
    ...
    if (isset($_POST['submit'])) {
        ...
        if(isset($_FILES['profileImg'])){
            ...
            if (in_array($fileActualExt,$allowed)){
                if ($fileError === 0 ){
                    if ($fileSize <  8388608999){
                        ...
                        if ($sql == true) {
                            ...
                            window.location = "../manage_material_table.php?section=speaking&type=repeat-sentence&update=success"; 
                            </script>
                            <?php    
                        }else{
                            ?>
                            <script type="text/javascript">    
                            window.location = "speaking_repeat_sentence.php?question=<?php echo $id ?>&error=1";
                            </script>
                            <?php
                        }
                    }else{
                        ?>
                        <script type="text/javascript">    
                        window.location = "speaking_repeat_sentence.php?question=<?php echo $id ?>&high=1";
                        </script>
                        <?php
                    }
                }else{
                    ?>
                    <script type="text/javascript">
                    window.location = "speaking_repeat_sentence.php?question=<?php echo $id ?>&file_error=1";
                    </script>
                    <?php
                }
            }else{
                ?>
                <script type="text/javascript">
                window.location = "speaking_repeat_sentence.php?question=<?php echo $id ?>&type=1"; 
                </script>
                <?php
            }
        }else{
