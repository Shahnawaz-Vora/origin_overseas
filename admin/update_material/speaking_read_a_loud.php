...
<head>
    ...
    <title>Update Materials-Speaking: Read Aloud | Origin Overseas - PTE tutors </title>
                                 ...
                                 <div class="row">
                                    <div class="col-md-11 mx-auto">
                                        <div class="form-group" align="center">
                                            <button class="btn btn-primary btn-rounded" name="submit" type="submit" style="width: 110px;margin-top: -10px;font-family: sans-serif;letter-spacing: 1.7px;margin-bottom: 15px">UPDATE</button>
                                        </div>
                                    </div>
                                 </div> 
                            </form>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($conn, "UPDATE material_speaking SET questionText='$question_text',answer='$answer',modify_date='$modify_date' WHERE speakingMaterialId= '$id'");
        echo $sql;
        if ($sql == true) {
            ?>
            <script type="text/javascript">    
            window.location.href = "../manage_material_table.php?section=speaking&type=read-aloud&update=success"; 
            </script>
            <?php    
        }else{
            ?>
            <script type="text/javascript"> 
            window.location.href = "speaking_read_a_loud.php?question=<?php echo $id ?>&error=1";
            </script>
            <?php
        }
    }
