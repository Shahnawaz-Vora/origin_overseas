...
<head>
    ...
    <title>Update Materials-Listening: Fill The Blanks | Origin Overseas - PTE tutors </title>
            ...
            if (in_array($fileActualExt,$allowed)){
                if ($fileError === 0 ){
                    if ($fileSize <  8388608999){
                        ...
                        $sql = mysqli_query($conn, "UPDATE material_listening SET audio='$fileNameNew', questionText='$question_text_replaced', transcript='$transcript', option1='$option[0]', option2='$option[1]', option3='$option[2]', option4='$option[3]', option5='$option[4]', option6='$option[5]', option7='$option[6]', option8='$option[7]',  modify_date='$modify_date'  WHERE listeningMaterialId='$question_id' ");
                        if ($sql == true) {
                            move_uploaded_file($fileTmpName,$fileDestination);
                            unlink("../../database/audio/".$originalFile);
                            ?>
                            <script type="text/javascript">    
                            window.location = "../manage_material_table.php?section=listening&type=fill-in-the-blanks&update=success"; 
                            </script>
                            <?php    
                        }else{
                            ?>
                            <script type="text/javascript">    
                            window.location = "listening_fill_in_the_blanks.php?question=<?php echo $question_id ?>&error=1";
                            </script>
                            <?php
                        }
                    }else{
                        ?>
                        <script type="text/javascript">
                        window.location = "listening_fill_in_the_blanks.php?question=<?php echo $question_id ?>&high=1";
                        </script>
                        <?php
                    }
                }else{
                        ?>
                        <script type="text/javascript">
                        window.location = "listening_fill_in_the_blanks.php?question=<?php echo $question_id ?>&file_error=1";
                        </script>
                        <?php
                }
            }else{
                ?>
                <script type="text/javascript">
                window.location = "listening_fill_in_the_blanks.php?question=<?php echo $question_id ?>&type=1"; 
                </script>
                <?php
            }
        }else{
