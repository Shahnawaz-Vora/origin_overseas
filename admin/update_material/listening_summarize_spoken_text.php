...
<head>
    ...
    <title>Update Materials-Listening: Summarize Spoken Text | Origin Overseas - PTE tutors </title>
            ...
            if (in_array($fileActualExt,$allowed)){
                if ($fileError === 0 ){
                    ...
                    if ($sql == true) {
                        ...
                        window.location = "../manage_material_table.php?section=listening&type=summarize-spoken-text&update=success"; 
                        </script>
                        <?php    
                    }else{
                        ?>
                ...
                ?>
                <script type="text/javascript">
                Snackbar.show({ text: 'You cannot Upload this type of file as Audio', duration: 2000, });
