...
<head>
    ...
    <title>Update Materials-Listening: Select Missing Word | Origin Overseas - PTE tutors </title>
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option1" >
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="0" id="radio1" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option1']) { echo 'checked=""'; } ?>>
                                                                             <input id="opt1" name="option1" class="form-control" value="<?php if (isset($row['option1'])) {echo stripcslashes($row['option1']);}?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="1" id="radio2" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option2']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <input id="opt2" name="option2" class="form-control" value="<?php if (isset($row['option2'])) {echo stripcslashes($row['option2']);}?>">
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="2" id="radio3" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option3']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <input id="opt3" name="option3" class="form-control" value="<?php if (isset($row['option3'])) {echo stripcslashes($row['option3']);}?>">
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="3" id="radio4" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option4']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <input id="opt4" name="option4" class="form-control" value="<?php if (isset($row['option4'])) {echo stripcslashes($row['option4']);}?>" >
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option5">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="4" id="radio5" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option5']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <input id="opt5" name="option5" class="form-control" value="<?php if (isset($row['option5'])) {echo stripcslashes($row['option5']);}?>">
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="5" id="radio6" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option6']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <input id="opt6" name="option6" class="form-control" value="<?php if (isset($row['option6'])) {echo stripcslashes($row['option6']);}?>">
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option7">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="6" id="radio7" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option7']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <input id="opt7" name="option7" class="form-control" value="<?php if (isset($row['option7'])) {echo stripcslashes($row['option7']);}?>">
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option8">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" name="radio" value="7" id="radio8" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option8']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <input id="opt8" name="option8" class="form-control" value="<?php if (isset($row['option8'])) {echo stripcslashes($row['option8']);}?>">
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if(isset($_FILES['profileImg'])){
            ...
            if (in_array($fileActualExt,$allowed)){
                if ($fileError === 0 ){
                    if ($fileSize <  8388608999999){
                        ...
                        $sql = mysqli_query($conn, "UPDATE `material_listening` SET `answer`='$answer',`option1`='$option[0]',`option2`='$option[1]',`option3`='$option[2]',`option4`='$option[3]',`option5`='$option[4]',`option6`='$option[5]',`option7`='$option[6]',`option8`='$option[7]',`audio`='$fileNameNew',`transcript`='$transcript',`modify_date`='$modify_date' WHERE `listeningMaterialId`='$question_id'");
                        if ($sql == true) {
                            move_uploaded_file($fileTmpName,$fileDestination);
                            unlink("../../database/audio/".$originalfile);
                            ?>
                            <script type="text/javascript">    
                            window.location = "../manage_material_table.php?section=listening&type=select-missing-word&update=success"; 
                            </script>
                            <?php    
                        }else{
                            ?>
            ...
            $sql = mysqli_query($conn, "UPDATE `material_listening` SET `answer`='$answer',`option1`='$option[0]',`option2`='$option[1]',`option3`='$option[2]',`option4`='$option[3]',`option5`='$option[4]',`option6`='$option[5]',`option7`='$option[6]',`option8`='$option[7]',`transcript`='$transcript',`modify_date`='$modify_date' WHERE `listeningMaterialId`='$question_id'");
                if ($sql == true) {
                    ?>
                    <script type="text/javascript">    
                    window.location = "../manage_material_table.php?section=listening&type=select-missing-word&update=success"; 
