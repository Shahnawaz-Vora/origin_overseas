...
$sql="SELECT * FROM material_listening WHERE listeningMaterialId='$id'";
...
<head>
    ...
    <title>Update Materials-Listening: Write From Dicatation | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Listening: Write From Dictation</span></li>
                            </ol>
                        </nav>
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing" style="margin-top: -55px">
                                                    ...
                                                    <div class="info" style="margin-top: -25px">
                                                        ...
                                                        <div class="row" style="margin-top: -45px">
                                                            <div class="col-md-11 mx-auto" align="center">
                                                                <div class="form-group">
                                                                   <textarea rows="7" class="form-control" id="transcript" name="transcript" required=""><?php echo stripslashes($row['transcript']); ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if(isset($_FILES['profileImg'])){
            ...
            if (in_array($fileActualExt,$allowed)){
                if ($fileError === 0 ){
                    if ($fileSize <  8388608999999){
                        ...
                        $sql = mysqli_query($conn, "UPDATE `material_listening` SET `answer`='$answer',`audio`='$fileNameNew',`transcript`=['$transcript'],`modify_date`='$modify_date' WHERE listeningMaterialId='$id'");
                        if ($sql == true) {
                            move_uploaded_file($fileTmpName,$fileDestination);
                            unlink("../../database/audio/".$originalfile);
                            ?>
                            <script type="text/javascript">    
                            window.location = "window.location = "../manage_material_table.php?section=listening&type=write-from-dictation&update=success"; 
                            </script>
                            <?php    
                        }else{
                            ?>
            ...
            $sql = mysqli_query($conn, "UPDATE `material_listening` SET `answer`='$answer',`transcript`=['$transcript'],`modify_date`='$modify_date' WHERE listeningMaterialId='$id'");
            if ($sql == true) {
