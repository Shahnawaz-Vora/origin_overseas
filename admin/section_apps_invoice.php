                                ...
                                <div class="tab-title">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-12">
                                            ...
                                            <?php 
                                            include_once '../database/dbh.inc.php';
                                            $sql = mysqli_query($conn,"SELECT * FROM section_test_purchase ORDER BY order_id DESC");
                                                                    ...
                                                                    <table class="table">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td>1</td>';
                                                                                $test_no = $row['test_no'];
                                                                                $test_sql = mysqli_query($conn,"SELECT test_name FROM manage_section_test WHERE test_no='$test_no' ");
