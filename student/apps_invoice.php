...
<!-- <body  onkeydown="return (event.keyCode == 154 && event.keyCode == 123 && event.Keycode == 17 && event.Keycode == 112 && event.Keycode == 113 && event.Keycode == 114 && event.Keycode == 115 && event.Keycode == 117 && event.Keycode == 118 && event.Keycode == 119 && event.Keycode == 120 && event.Keycode == 121 && event.Keycode == 122 )"> -->
<body >
                                ...
                                <div class="tab-title">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-12">
                                            ...
                                            include_once '../database/dbh.inc.php';
                                            $studentId = $_COOKIE['studentId'];
                                            $query = "(SELECT * from test_purchase where `studentId` = ".$studentId.")
                                            UNION
                                            (SELECT * from section_test_purchase where `studentId` =".$studentId.")";
                                                                    ...
                                                                    <table class="table">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td>1</td>';
                                                                                $test_no = $row['test_no'];
                                                                                $query = "(SELECT test_name from manage_test where test_no='$test_no')
                                                                                    UNION
                                                                                    (SELECT test_name from manage_section_test where test_no='$test_no')";
                                                                                    $test_sql = mysqli_query($conn,$query);
