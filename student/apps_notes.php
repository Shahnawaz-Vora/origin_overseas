                        ...
                        <div class="app-container">
                            ...
                            <div class="app-note-container">
                                ...
                                <div class="note-container note-grid">
                                    ...
                                    include_once '../database/dbh.inc.php';
                                    $studentId = $_COOKIE['studentId'];
                                    $sql = mysqli_query($conn,"SELECT * FROM student_notes WHERE studentId=$studentId");
                                    $i=0;
...
if (isset($_POST['add_notes'])) {
    ...
    $sql = mysqli_query($conn, "INSERT INTO student_notes(title, description,studentId,modify_date) VALUES ('$title', '$description',$studentId,'$modify_date' ) ");
    ?>
    <script type="text/javascript">
...
if (isset($_POST['delete_note'])) {
    ...
    $studentId = $_COOKIE['studentId'];
    $sql = mysqli_query($conn, "DELETE FROM student_notes WHERE id=$id and studentId=$studentId ");
    ?>
    <script type="text/javascript">
        window.location = "apps_notes.php";
    </script> 
