                                        ...
                                        <div class=" font-weight-bold" style="color:black;font-size: 3em;margin-left: 80px;margin-top: -40px">Microphone Check</div><br><br>
                                            ...
                                            <div align="left" class="mt-3" style="margin-left: 300px;">
                                                ...
                                                if(isset($_GET['testno']) && isset($_GET['question']))
                                                {
                                                    ...
                                                    ?>
                                                    <button class="btn btn-rounded btn-outline-info" type="button" onclick=location.href='keyboard.php?testno=<?php echo $test_no; ?>&question=<?php echo $question; ?>&non_timer=1&section=<?php echo $section ; ?>'>Next</button>
                                                    <?php
                                                }
                                                else
                                                {
                                                    ...
                                                    $section = $_GET['section'];
                                                    ?>
                                                    <button class="btn btn-rounded btn-outline-info" type="button" onclick=location.href='keyboard.php?testno=<?php echo $test_no; ?>&non_timer=1&section=<?php echo $section ; ?>'>Next</button>
                                                    <?php
                                                }
                                                ?>
                                            </div>
