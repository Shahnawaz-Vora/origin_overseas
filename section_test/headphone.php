                                    ...
                                    <div class=" mt-5 text-left text-dark">
                                        <div class=" font-weight-bold" style="color:black;font-size: 3em;margin-left: 80px;margin-top: -40px">Headphone Check</div><br><br>
                                            ...
                                            if(isset($_GET['testno']) && isset($_GET['question']))
                                            {
                                                ...
                                                ?>
                                                <button class="btn btn-rounded btn-outline-info" type="button" onclick=location.href='microphone.php?testno=<?php echo $test_no; ?>&question=<?php echo $question; ?>&non_timer=1&section=<?php echo $section ; ?>'>Next</button>
                                                <?php
                                            }
                                            else
                                            {
                                                ...
                                                $section = $_GET['section'];
                                                ?>
                                                <button class="btn btn-rounded btn-outline-info" type="button" onclick=location.href='microphone.php?testno=<?php echo $test_no; ?>&non_timer=1&section=<?php echo $section ; ?>'>Next</button>
                                                <?php
                                            }
                                            ?> 
                                            </div>
