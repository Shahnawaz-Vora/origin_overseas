...
<?php 
    ...
    if(isset($_GET['question']))
    {
        ...
        $studentId= $_COOKIE['studentId'];
        $test_no = $row['test_no'];
        $question_no = $row['question_no']+2;
        $user_sql = mysqli_query($conn , "SELECT * from section_user_test WHERE studentId='$studentId' AND test_no='$test_no' AND section='reading' AND type='multiple-answers' AND question_no='$question_no' ");
...
<head>
    ...
    <title>Reading: Multiple-choice, choose multiple answer | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"> <a href="../view_test_table.php?section=reading&testno=<?php echo $row['test_no']; ?>&type=multiple-answer"> Reading: Multiple Answer </a> </li>
                                        ...
                                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 layout-top-spacing">
                                                    <br><h4><center><b>Multiple-choice, choose multiple answer</b> : Question <?php echo $question_no; ?></center></h4><br>
                                                </div>
                                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing" style="margin-top: 0px">
                                                        ...
                                                        <div class="row" style="margin-top: -45px">
                                                            <div class="col-md-11 mx-auto" align="center">
                                                                <div class="form-group">
                                                                   <textarea rows="3" disabled="true" style="color:black;" class="form-control" id="question_text" name="question" required=""><?php echo stripslashes($row['question']); ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="info" style="margin-top: -15px">
                                                        ...
                                                        <div class="row" style="margin-top: -45px">
                                                            <div class="col-md-11 mx-auto" align="center">
                                                                <div class="form-group">
                                                                   <textarea rows="7" disabled="true" style="color:black;" class="form-control" id="question" name="question_text" required=""><?php echo stripslashes($row['questionText']); ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    ?>
                                                    <div class="info" style="display:none;margin-top: -15px"> 
                                                                ...
                                                                <div class="row" >
                                                                    <div class="col-md-12" style="display: none;" id="option1" >
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="btn-group w-100">
                                                                                <input type="checkbox" disabled="true" name="checkbox" value="0" id="checkbox1" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php for ($i=0; $i < count($answer); $i++) { if ($answer[$i] == $row['option1']) {echo 'checked=""'; break; } } ?> >
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option2">
                                                                        <div class="form-group">
                                                                            <label for="option1"  style="margin-left: 54px;">Option 2</label>
                                                                             <div class="btn-group w-100">
                                                                                <input type="checkbox" disabled="true" name="checkbox" value="1" id="checkbox2" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php for ($i=0; $i < count($answer); $i++) { if ($answer[$i] == $row['option2']) {echo 'checked=""'; break; } } ?> >
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option3">
                                                                        <div class="form-group">
                                                                            <label for="option1"  style="margin-left: 54px;">Option 3</label>
                                                                             <div class="btn-group w-100">
                                                                                <input type="checkbox" disabled="true" name="checkbox" value="2" id="checkbox3" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php for ($i=0; $i < count($answer); $i++) { if ($answer[$i] == $row['option3']) {echo 'checked=""'; break; } } ?> >
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option4">
                                                                        <div class="form-group">
                                                                            <label for="option1"  style="margin-left: 54px;">Option 4</label>
                                                                             <div class="btn-group w-100">
                                                                                <input type="checkbox" disabled="true" name="checkbox" value="3" id="checkbox4" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php for ($i=0; $i < count($answer); $i++) { if ($answer[$i] == $row['option4']) {echo 'checked=""'; break; } } ?> >
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option5">
                                                                        <div class="form-group">
                                                                            <label for="option1"  style="margin-left: 54px;">Option 5</label>
                                                                             <div class="btn-group w-100">
                                                                            <input type="checkbox" disabled="true" name="checkbox" value="4" id="checkbox5" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php for ($i=0; $i < count($answer); $i++) { if ($answer[$i] == $row['option5']) {echo 'checked=""'; break; } } ?> >
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option6">
                                                                        <div class="form-group">
                                                                            <label for="option1"  style="margin-left: 54px;">Option 6</label>
                                                                             <div class="btn-group w-100">
                                                                            <input type="checkbox" disabled="true" name="checkbox" value="5" id="checkbox6" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php for ($i=0; $i < count($answer); $i++) { if ($answer[$i] == $row['option6']) {echo 'checked=""'; break; } } ?> >
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option7">
                                                                        <div class="form-group">
                                                                             ...
                                                                             <div class="btn-group w-100">
                                                                            <input type="checkbox" disabled="true" name="checkbox" value="6" id="checkbox7" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php for ($i=0; $i < count($answer); $i++) { if ($answer[$i] == $row['option7']) {echo 'checked=""'; break; } } ?> >
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option8">
                                                                        <div class="form-group">
                                                                             ...
                                                                             <div class="btn-group w-100">
                                                                                <input type="checkbox" disabled="true" name="checkbox" value="7" id="checkbox8" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php for ($i=0; $i < count($answer); $i++) { if ($answer[$i] == $row['option8']) {echo 'checked=""'; break; } } ?> >
    ...
    <script type="text/javascript">
        $("#prev").click(function(event) {
            <?php
                if($question_no == 1)
                {
                    $sql6 = mysqli_query($conn , "select id from section_test where test_no='$test_no' and section='reading' and type='single-answer' and question_no='2'");
                ...
                else
                {
                    ...
                    $sql6 = mysqli_query($conn , "select id from section_test where test_no='$test_no' and section='reading' and type='multiple-answers' and question_no='$question_prev'");
                    $row6= mysqli_fetch_assoc($sql6); 
                    $id= $row6['id'];
                    ?>
        ...
        $("#next").click(function(event) {
            <?php
                if($question_no == 2)
                {
                    $sql6 = mysqli_query($conn , "select id from section_test where test_no='$test_no' and section='reading' and type='reorder-paragraph' and question_no='1'");
                    $row6= mysqli_fetch_assoc($sql6);  
                    $id= $row6['id'];
                    ?>
                    location.replace("reading_reorder_paragraph.php?question=<?php echo $id; ?>"); <?php
                }
                else
                {
                    $question_next=$row['question_no']+1;
                    $sql6 = mysqli_query($conn , "select id from section_test where test_no='$test_no' and section='reading' and type='multiple-answers' and question_no='$question_next'");
                    $row6= mysqli_fetch_assoc($sql6); 
                    $id= $row6['id'];
                    ?>
                    location.replace("reading_multiple_answer.php?question=<?php echo $id; ?>");
