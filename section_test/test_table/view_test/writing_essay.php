...
<?php 
    ...
    if(isset($_GET['question']))
    {
        ...
        $test_no = $row['test_no'];
        $question_no = 4;
        $user_sql = mysqli_query($conn , "SELECT * from section_user_test WHERE studentId='$studentId' AND test_no='$test_no' AND section='writing' AND type='essay' AND question_no='$question_no' ");
...
<body>
    ...
    <script type="text/javascript">
        $("#prev").click(function(event) {
            <?php
            $sql6 = mysqli_query($conn , "select id from section_test where test_no='$test_no' and section='writing' and type='summarize-written-text' and question_no='3'");
        ...
        $("#next").click(function(event) {
            <?php
            $sql6 = mysqli_query($conn , "select id from section_test where test_no='$test_no' and section='reading' and type='single-answer' and question_no='1'");
            $row6= mysqli_fetch_assoc($sql6);  
            $id= $row6['id'];
            ?>
