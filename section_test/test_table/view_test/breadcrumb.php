...
<script type="text/javascript">
    $("#step1").click(function(event) {
        <?php
        $id5 = $_GET['question'];
        $sql5 = mysqli_query($conn , "select id from section_test where section='speaking' and type='read-aloud' and test_no='$test_no'");
    ...
    $("#step2").click(function(event) {
        <?php
        $id5 = $_GET['question'];
        $sql5 = mysqli_query($conn , "select id from section_test where section='writing' and type='summarize-written-text' and test_no='$test_no'");
        $row5= mysqli_fetch_assoc($sql5);
        ?>
    ...
    $("#step3").click(function(event) {
        <?php
        $id5 = $_GET['question'];
        $sql5 = mysqli_query($conn , "select id from section_test where section='reading' and type='single-answer' and test_no='$test_no'");
        $row5= mysqli_fetch_assoc($sql5);
        ?>
    ...
    $("#step4").click(function(event) {
        <?php
        $id5 = $_GET['question'];
        $sql5 = mysqli_query($conn , "select id from section_test where section='listening' and type='summarize-spoken-text' and test_no='$test_no'");
        $row5= mysqli_fetch_assoc($sql5);
        ?>
