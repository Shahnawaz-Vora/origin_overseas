...
<?php 
    ...
    if(isset($_GET['question']))
    {
        ...
        $studentId= $_COOKIE['studentId'];
        $test_no = $row['test_no'];
        $question_no = $row['question_no']+8;
        $user_sql = mysqli_query($conn , "SELECT * from section_user_test WHERE studentId='$studentId' AND test_no='$test_no' AND section='listening' AND type='highlight-correct-summary' AND question_no='$question_no' ");
...
<head>
    ...
    <title>Listening: Highlight Correct Summary | Origin Overseas - PTE tutors </title>
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"> <a href="../view_test_table.php?section=listening&testno=<?php echo $row['test_no']; ?>&type=highlight-correct-summary"> Listening: Highlight Correct Summary </a> </li>
                                        ...
                                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 layout-top-spacing" >
                                                    <br><h4><center><b>Highlight Correct Summary</b> : Question <?php echo $question_no; ?></center></h4><br>
                                                    <div class="info">
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing" style="margin-top: -15px">
                                                    ...
                                                    <div class="info" style="margin-top: -15px">
                                                        ...
                                                        <div class="row" style="display:none;margin-top: -55px">
                                                            <div class="col-md-11 mx-auto" align="center">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option1" >
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" disabled="true" name="radio" value="0" id="radio1" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option1']) { echo 'checked=""'; } ?>>
                                                                             <textarea  name="option1" disabled="true" style="color:black;" class="form-control" id="opt1"><?php if (isset($row['option1'])) {echo stripcslashes($row['option1']);}?></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" disabled="true" name="radio" value="1" id="radio2" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option2']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <textarea  name="option2" disabled="true" style="color:black;" class="form-control" id="opt2" ><?php if (isset($row['option2'])) {echo stripcslashes($row['option2']);}?></textarea>
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" disabled="true" name="radio" value="2" id="radio3" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option3']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <textarea  name="option3" disabled="true" style="color:black;" class="form-control" id="opt3" ><?php if (isset($row['option3'])) {echo stripcslashes($row['option3']);}?></textarea>
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" disabled="true" name="radio" value="3" id="radio4" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option4']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <textarea  name="option4" disabled="true" style="color:black;" class="form-control" id="opt4"><?php if (isset($row['option4'])) {echo stripcslashes($row['option4']);}?></textarea>
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-12" style="display: none;" id="option5">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" disabled="true" name="radio" value="4" id="radio5" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option5']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <textarea  name="option5" disabled="true" style="color:black;" class="form-control" id="opt5"><?php if (isset($row['option5'])) {echo stripcslashes($row['option5']);}?></textarea>
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" disabled="true" name="radio" value="5" id="radio6" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option6']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <textarea  name="option6" disabled="true" style="color:black;" class="form-control" id="opt6"><?php if (isset($row['option6'])) {echo stripcslashes($row['option6']);}?></textarea>
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option7">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" disabled="true" name="radio" value="6" id="radio7" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option7']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <textarea name="option7" disabled="true" style="color:black;" class="form-control" id="opt7"><?php if (isset($row['option7'])) {echo stripcslashes($row['option7']);}?></textarea>
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="display: none;" id="option8">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="radio" disabled="true" name="radio" value="7" id="radio8" class="mr-4 form-control" style="width: 25px;box-shadow: none;" <?php if ($row['answer'] == $row['option8']) { echo 'checked=""'; } ?>>
                                                                             ...
                                                                             <textarea name="option8" disabled="true" style="color:black;" class="form-control" id="opt8"><?php if (isset($row['option8'])) {echo stripcslashes($row['option8']);}?></textarea>
                                                                         </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
    ...
    <script type="text/javascript">
        $("#prev").click(function(event) {
            <?php
                if($question_no == 1)
                {
                    $sql6 = mysqli_query($conn , "select id from section_test where test_no='$test_no' and section='listening' and type='fill-in-the-blanks' and question_no='3'");
                ...
                else
                {
                    ...
                    $sql6 = mysqli_query($conn , "select id from section_test where test_no='$test_no' and section='listening' and type='highlight-correct-summary' and question_no='$question_prev'");
                    $row6= mysqli_fetch_assoc($sql6); 
                    $id= $row6['id'];
                    ?>
                    location.replace("listening_highlight_correct_summary.php?question=<?php echo $id; ?>");
                    <?php
                }
            ?>
        });
        $("#next").click(function(event) {
            <?php
                if($question_no == 2)
                {
                    $sql6 = mysqli_query($conn , "select id from section_test where test_no='$test_no' and section='listening' and type='single-answer' and question_no='1'");
                    $row6= mysqli_fetch_assoc($sql6);  
                    $id= $row6['id'];
                    ?>
                    location.replace("listening_single_answer.php?question=<?php echo $id; ?>"); <?php
                }
                else
                {
                    $question_next=$row['question_no']+1;
                    $sql6 = mysqli_query($conn , "select id from section_test where test_no='$test_no' and section='listening' and type='highlight-correct-summary' and question_no='$question_next'");
                    $row6= mysqli_fetch_assoc($sql6); 
                    $id= $row6['id'];
                    ?>
                    location.replace("listening_highlight_correct_summary.php?question=<?php echo $id; ?>");
