...
<?php 
    ...
    $sql = mysqli_query($conn , "SELECT distinct(test_no),modify_date from section_user_test where studentId=$student_id and ( question_no=32 OR  question_no=4 OR  question_no=18 OR  question_no=21 ) ");
                                                ...
                                                <?php 
                                                    ...
                                                    while($row = mysqli_fetch_assoc($sql)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            ';
                                                        $test_no = $row['test_no'];
                                                        $sql1 = mysqli_query($conn,"select * from manage_section_test where test_no='$test_no'");
                                                        $row1 = mysqli_fetch_assoc($sql1);
                                                        $sql2 = mysqli_query($conn,"SELECT avg(marks) as overall_average from user_section_test where test_no='$test_no' and studentId='$student_id'");
                                                        $row2 = mysqli_fetch_assoc($sql2);
                                                        $sql3= mysqli_query($conn,"SELECT * from section_test_evaluation where test_no='$test_no' and studentId='$student_id'");
