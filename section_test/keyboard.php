...
<body>
    ...
    <div class="main-container" id="container">
                                        ...
                                        <div class=" font-weight-bold" style="color:black;font-size: 3em;margin-left: 80px;margin-top: -40px">Keyboard Check</div><br><br>
                                            ...
                                            <div align="center" class="mt-4" style="margin-left: -650px;">
                                                ...
                                                if(isset($_GET['testno']) && isset($_GET['question']))
                                                {
                                                    ...
                                                    else if($section == "writing")
                                                    {
                                                        ...
                                                        if($question == 4)
                                                        {
                                                            ...
                                                            ?>
                                                            <button class="btn btn-rounded btn-outline-info" type="button" onclick=location.href='writing.php?test_no=<?php echo $test_no; ?>&question=1&type=essay&section=writing&non_timer=1'>Next</button>
                                                            <?php   
                                                        }
                                                        if($question >= 5)
                                                        {
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        ?>
                                                        <button class="btn btn-rounded btn-outline-info" type="button" onclick=location.href='writing.php?test_no=<?php echo $test_no; ?>&question=1&non_timer=1&type=summarize-written-text'>Next</button>
                                                        <?php    
                                                    }
                                                    else if($section == "reading")
                                                    {
                                                        ?>
                                                        <button class="btn btn-rounded btn-outline-info" type="button" onclick=location.href='reading.php?test_no=<?php echo $test_no; ?>&non_timer=1&question=1&type=single-answer'>Next</button>
                                                        <?php   
                                                    }
                                                    else if($section == "listening")
                                                    {
                                                        ?>
                                                        <button class="btn btn-rounded btn-outline-info" type="button" onclick=location.href='listening_section.php?test_no=<?php echo $test_no; ?>&non_timer=1&question=1&type=summarize-spoken-text&section=listening&temp=1'>Next</button>
                                                        <?php
                                                    }
                                                }
                                                ?>
        ...
        <!--  END CONTENT AREA  -->
        <img src="../assets/img/keyboard.png" alt="keyboard" style="margin-left: 55%;z-index:1;margin-top: -30%;width: 50%;height:50%"  align="right">
        <img src="../assets/img/logo.png" alt="keyboard" style="margin-left: 0;z-index:1;margin-top: -10%;width: 22%;height:22%"  align="right">
    </div>
    <!-- END MAIN CONTAINER -->
