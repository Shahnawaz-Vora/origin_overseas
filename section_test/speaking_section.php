...
if (!isset($_GET['resume']) && isset($_GET['question']) == 1)
{
    ...
    $test_no = $_GET['testno'];
    $question=1;
    $sql = "SELECT * from section_test where test_no = '$test_no' and type='$type' and question_no=1 and section='speaking'";
...
if(isset($_GET['resume']) && isset($_GET['question']))
{
    ...
    $test_no = $_GET['testno'];
        ...
        $sql = "select * from section_test where test_no = '$test_no' and type='$type' and question_no='$question_query' and section='speaking'";
                                            ...
                                            <div class="row mt-5">
                                                <div class="col-xl-6" align="left">
                                                    <div style="color: black;font-weight: bolder;font-size: 18px;margin-left: 25px;"  class="">
                                                        <button class="mb-2 btn btn-outline-danger  title-text text-dark font-weight-bold"><span id="question_number">1</span>  of 38</button>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        {    
            ...
            if(crr >=8 && crr <= 17)
            {
                ...
                $sql1 = "select * from section_test where test_no = '$test_no' and type='$type' and question_no='$question_query' and section='speaking' ";
