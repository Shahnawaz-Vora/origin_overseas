...
<body data-spy="scroll" data-target="#navSection" data-offset="100">
    ...
    <script type="text/javascript">
        ...
        var min=44;
        var timeleft=59;
        var timer_resume = <?php if (isset($_GET['question'])== 1) {echo 0;}else{echo 1;}?>;
        // var timer_resume = 1;
                                    ...
                                    <div class="row ">
                                        <div class="col-xl-6" align="left">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-left: 25px;"  class="">
                                                <button class="mb-2 btn btn-outline-danger  title-text text-dark font-weight-bold" ><span id="question_number">1</span>  of 21</button>
                                            </div>
                                        </div>
                            ...
                            <div class="statbox widget box box-shadow" id="p4q2" style="width: 115%;margin-left: -92px;margin-top:-10px;display: none;">   
                                ...
                                <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px;">
                                    <div class="row ">
                                        <div class="col-xl-6" align="left">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-left: 25px;"  class="">
                                                <button class="mb-2 btn btn-outline-danger  title-text text-dark font-weight-bold" ><span id="question_number">4</span>  of 21</button>
                                            </div>
                                        </div>
                                        <div class="col-xl-6" align="right">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-right: 25px;">
                            ...
                            <div class="statbox widget box box-shadow" id="p4q3" style="width: 115%;margin-left: -92px;margin-top:-10px;display: none;">   
                                ...
                                <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px;">
                                    <div class="row " style="margin-top: 80px;">
                                        <div class="col-xl-6" align="left">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-left: 25px;"  class="">
                                                <button class="mb-2 btn btn-outline-danger  title-text text-dark font-weight-bold" ><span id="question_number">6</span>  of 21</button>
                                            </div>
                                        </div>
                                        <div class="col-xl-6" align="right">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-right: 25px;">
                            ...
                            <div class="statbox widget box box-shadow" id="p4q4" style="width: 115%;margin-left: -92px;margin-top:-10px;display: none;"> 
                                ...
                                <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px;">
                                    <div class="row " style="margin-top: 80px;">
                                        <div class="col-xl-6" align="left">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-left: 25px;"  class="">
                                                <button class="mb-2 btn btn-outline-danger  title-text text-dark font-weight-bold" ><span id="question_number">9</span>  of 21</button>
                                            </div>
                                        </div>
                                        <div class="col-xl-6" align="right">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-right: 25px;">
                            ...
                            <div class="statbox widget box box-shadow" id="p4q5" style="width: 115%;margin-left: -92px;margin-top:-10px;display: none;"> 
                                ...
                                <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px;">
                                    <div class="row " style="margin-top: 80px;">
                                        <div class="col-xl-6" align="left">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-left: 25px;"  class="">
                                                <button class="mb-2 btn btn-outline-danger  title-text text-dark font-weight-bold" ><span id="question_number">11</span>  of 21</button>
                                            </div>
                                        </div>
                                        <div class="col-xl-6" align="right">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-right: 25px;">
                            ...
                            <div class="statbox widget box box-shadow" id="p4q6" style="width: 115%;margin-left: -92px;margin-top:-10px;display: none;"> 
                                ...
                                <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px;">
                                    <div class="row " style="margin-top: 80px;">
                                        <div class="col-xl-6" align="left">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-left: 25px;"  class="">
                                                <button class="mb-2 btn btn-outline-danger  title-text text-dark font-weight-bold" ><span id="question_number">13</span>  of 21</button>
                                            </div>
                                        </div>
                                        <div class="col-xl-6" align="right">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-right: 25px;">
                            ...
                            <div class="statbox widget box box-shadow" id="p4q7" style="width: 115%;margin-left: -92px;margin-top:-10px;display: none;"> 
                                ...
                                <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px;">
                                    <div class="row " style="margin-top: 80px;">
                                        <div class="col-xl-6" align="left">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-left: 25px;"  class="">
                                                <button class="mb-2 btn btn-outline-danger  title-text text-dark font-weight-bold" ><span id="question_number">15</span>  of 21</button>
                                            </div>
                                        </div>
                                        <div class="col-xl-6" align="right">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-right: 25px;">
                            ...
                            <div class="statbox widget box box-shadow" id="p4q8" style="width: 115%;margin-left: -92px;margin-top:-10px;display: none;"> 
                                ...
                                <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px;">
                                    <div class="row " style="margin-top: 80px;">
                                        <div class="col-xl-6" align="left">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-left: 25px;"  class="">
                                                <button class="mb-2 btn btn-outline-danger  title-text text-dark font-weight-bold" ><span id="question_number">18</span>  of 21</button>
                                            </div>
                                        </div>
                                        <div class="col-xl-6" align="right">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-right: 25px;">
...
<script type="text/javascript">
    ...
    function summarize_spoken_text(){    
        ...
        $.ajax({
            url: 'ajax.php',
            type: 'POST',
            data: {remaining_time: remaining_time,summarize_writing_que: que,type: type,test_no:test_no,answer:userans,word_count:wordCount,section:"listening"},
            success: function (response) {
                if(que == 3)
                {
                    var obj = JSON.parse(response);
    ...
    function multiple_answers(){
        ...
        $.ajax({
            url: 'ajax.php',
            type: 'POST',
            data: {remaining_time: remaining_time,summarize_writing_que: que,type: type,test_no:test_no,answer:userans,marks:marks,section:"listening"},
            success: function (response) {
                if(que == 5){
                    var obj = JSON.parse(response)
                    document.getElementById("p4q1").style.display = 'none';
    ...
    function write_from_dictation(){
        ...
        $.ajax({
            url: 'ajax.php',
            type: 'POST',
            data: {remaining_time: remaining_time,summarize_writing_que: que,type: type,test_no:test_no,answer:userans,word_count:wordCount1,section:"listening"},
            success: function (response) {
                if(que >= 21)
                {
                    swal({
