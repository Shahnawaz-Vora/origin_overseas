...
<script>
    ...
    include '../../database/dbh.inc.php';
     ...
     if ($signature == $computedSignature && $txStatus == 'SUCCESS') {
        ...
        $sql = mysqli_query($conn, "INSERT INTO section_test_purchase(order_id,studentId,test_no,email,mobileNo,amount,referenceId,status,payment_mode,payment_time,signature) VALUES ('$orderId','$student_id','$test_no','email','$mobileNo','$price','$referenceId','$txStatus','$paymentMode','$txTime','$signature')");
        if($sql == true)
        {
