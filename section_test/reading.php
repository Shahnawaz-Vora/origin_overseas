    ...
    function reading_section(){
            if(question == 1)
            {
                ...
                if (type == 'single-answer') {
                    location.replace('reading_single_answer.php?question='+question+'&test_no='+test_no+'&non_timer=0');    
                }else if (type  ==  'multiple-answer') {
                    location.replace('reading_multiple_answer.php?question='+question+'&test_no='+test_no+'&non_timer=0');
                }else if (type  ==  'reorder-paragraph') {
                    location.replace('reading_reorder_paragraph.php?question='+question+'&test_no='+test_no+'&non_timer=0');
                }else if (type  ==  'fill-in-the-blanks') {
                    location.replace('reading_fill_in_the_blanks.php?question='+question+'&test_no='+test_no+'&non_timer=0');
                }else if (type  ==  'reading-writing-fill-in-the-blanks') {
                    location.replace('reading_writing_fill_the_blanks.php?question='+question+'&test_no='+test_no+'&non_timer=0');
                }else if(type == '')
                {
                ...
                var type = "<?php echo $_GET['type']; ?>";
                if (type == 'single-answer') {
                    location.replace('reading_single_answer.php?question='+question+'&test_no='+test_no+'&resume=1&non_timer=0');    
                }else if (type  ==  'multiple-answer') {
                    location.replace('reading_multiple_answer.php?question='+question+'&test_no='+test_no+'&resume=1&non_timer=0');
                }else if (type  ==  'reorder-paragraph') {
                    location.replace('reading_reorder_paragraph.php?question='+question+'&test_no='+test_no+'&resume=1&non_timer=0');
                }else if (type  ==  'fill-in-the-blanks') {
                    location.replace('reading_fill_in_the_blanks.php?question='+question+'&test_no='+test_no+'&resume=1&non_timer=0');
                }else if (type  ==  'reading-writing-fill-in-the-blanks') {
                    location.replace('reading_writing_fill_the_blanks.php?question='+question+'&test_no='+test_no+'&resume=1&non_timer=0');
                }else if(type == '')
                {
                    location.replace('reading_single_answer.php?question='+question+'&test_no='+test_no+'&continue=1');    
                }
