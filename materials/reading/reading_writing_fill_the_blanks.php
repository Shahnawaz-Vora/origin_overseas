...
<head>
    ...
    <title>Reading: Reading and Writing: Fill in the Blanks | Free Materials | PTE Materials | Origin Overseas | PTE Tutors </title>
    <meta name="description" content="Free PTE Material for Reading section's Reading and Writing: Fill in the Blanks questions">
...
<body data-spy="scroll" data-target="#navSection" data-offset="100">
                            ...
                            <div class="statbox widget box box-shadow">
                                <?php
                                    ...
                                    if (isset($_GET['question'])) {
                                        ...
                                        $_SESSION['reading-writing-fill-id'] = $question_id;
                                        $_SESSION['reading-writing-fill-num'] = $_GET['number'];
                                        ...
                                        if (isset($_SESSION['reading-writing-fill-id'])) {
                                            $question_id = $_SESSION['reading-writing-fill-id'];
                                            $sql="SELECT * FROM material_reading WHERE type='reading-and-writing-fill-in-the-blanks' and readingMaterialId='$question_id'";
                                        }else{
                                            $sql="SELECT * FROM material_reading WHERE type='reading-and-writing-fill-in-the-blanks' ";
                                        }
                                    }
                                                ...
                                                <div class="container">
                                                    <div class="container">
                                                        <div class="col-xl-12 mb-2" style="margin-top: -30px;">
                                                            <p class="paragraph text-justify" id="questionText" style="font-size: 1.1em;line-height: 2.5em;">
                                                                <?php
                                    ...
                                    <div class="widget-content widget-content-area icon-pill" id="alter_pagination" >
                                        ...
                                        <div class="row" >
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-sm-3 col-12 mb-3 " align="left">
                                               <button class="btn btn-primary" id="submitbtn" name="submit" type="button">Submit</button>
                                            ...
                                            <!-- Pagination start -->
                                            <?php
                                                if (isset($_SESSION['reading-writing-fill-num'])) {
                                                    $pageNo = indexes($_SESSION['reading-writing-fill-num']);
                                                    // print_r($pageNo);
                                                }else{
                                                    $pageNo = indexes(1);
                                                    $_SESSION['reading-writing-fill-num'] = "1";
                                                    // echo $pageNo;
                                                }
                                            ?>  
                                                ...
                                                <div class="pagination-no_spacing">
                                                    <ul class="pagination">
                                                        <?php
                                                                ...
                                                                if($pageNo[1]==$_SESSION['reading-writing-fill-num']){ 
                                                                    echo '
                                                                    <li>
                                                                        <a class="prev">
                                                                    ...
                                                                    echo '
                                                                    <li>
                                                                        <a href="reading_writing_fill_the_blanks.php?question='.$pageNo[0].'&number='.$pageNo[1].'" class="prev">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>    
                                                                        </a>
                                                                    </li>
                                                                    ';
                                                                    echo '<li><a href="reading_writing_fill_the_blanks.php?question='.$pageNo[0].'&number='.$pageNo[1].'">'.$pageNo[1].'</a></li>';
                                                                }
                                                            
                                                        
                                                            if ($pageNo[3] == $_SESSION['reading-writing-fill-num']) {
                                                                echo '
                                                                <li><a class="active" >'.$pageNo[3].'</a></li>
                                                                ';
                                                            }else{
                                                                echo '
                                                                <li><a href="reading_writing_fill_the_blanks.php?question='.$pageNo[2].'&number='.$pageNo[3].'">'.$pageNo[3].'</a></li>
                                                                ';
                                                            }
                                                            
                                                        
                                                            if ($pageNo[4] != "") {
                                                                if($pageNo[5]==$_SESSION['reading-writing-fill-num']){
                                                                    echo '<li><a href="reading_writing_fill_the_blanks.php?question='.$pageNo[4].'&number='.$pageNo[5].'" class="active">'.$pageNo[5].'</a></li>';
                                                                }else{
                                                                    echo '<li><a href="reading_writing_fill_the_blanks.php?question='.$pageNo[4].'&number='.$pageNo[5].'">'.$pageNo[5].'</a></li>';
                                                                }
                                                                echo '
                                                                <li>
                                                                    <a href="reading_writing_fill_the_blanks.php?question='.$pageNo[4].'&number='.$pageNo[5].'" class="next">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" align="right">
                                                <div class="dropup" >
                                                    ...
                                                    $sql1="SELECT * FROM material_reading WHERE type='reading-and-writing-fill-in-the-blanks' ";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                    $tot_row1 = mysqli_num_rows($result1);
                                                    echo $_SESSION['reading-writing-fill-num']; 
                                                    ?>
                                                    of 
                                                    <?php echo $tot_row1 ?>
                                                    </button>
                                                            ...
                                                            <div class="row no-gutters">
                                                                ...
                                                                while($row1 = mysqli_fetch_assoc($result1)) { 
                                                                    ...
                                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 " >
                                                                        <a href="reading_writing_fill_the_blanks.php?question='.$row1['readingMaterialId'].'&number='.$i.'">
    ...
    <?php
        function indexes($value){
            include '../../database/dbh.inc.php';
            $query ="SELECT * FROM material_reading WHERE type='reading-and-writing-fill-in-the-blanks' ";
    ...
    $("#submitbtn").click(function(){
        ...
        for(var i=0; i<span;i++){
            ...
            if ($('#questionText #ans'+j).val() == null || $('#questionText #ans'+j).val() == "") {
                Snackbar.show({
    ...
    for (var i = 0; i < span; i++) {
        var j = i+1;
        var id = "#questionText #ans"+j;
        if (trueAns[i].localeCompare(userAns[i]) == 0) {
            $("#questionText #replace").eq(i).prepend('<svg id="svg'+j+'" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather mr-1 feather-check"><polyline points="20 6 9 17 4 12"></polyline></svg>');
            $(id).prop("disabled","disabled");
            $(id).css("border","solid green 1px");
            $(id).css("color","green");
            $(id).css("background-color","#c1f881e3");
            $("svg"+j).css("margin","2px 2px");

        }else{
            $("#questionText #replace").eq(i).prepend('<svg id="svg'+j+'" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather mr-1 feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>');
            $(id).css("background-color","#ff766c8c");
            $(id).prop("disabled","disabled");
            $(id).css("color","red");
    ...
    function resetdata(){
        ...
        for (var i = 1; i <= span; i++) {
            var id = "#questionText #ans"+i;
            $("#svg"+i).remove();
            var j = i-1;
            // $("#questionText select").eq(j).selectedIndex = 0;
