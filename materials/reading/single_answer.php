...
<head>
    ...
    <title>Reading: Multiple-choice, choose Single answer | Single Answers | Free Materials | PTE Materials | Origin Overseas | PTE Tutors </title>
    <meta name="description" content="Free PTE Material for Reading section's Multiple-choice, choose Single answer questions">
...
<body data-spy="scroll" data-target="#navSection" data-offset="100">
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Single Answer</span></li>
                            </ol>
                        </nav>
                            ...
                            <div class="statbox widget box box-shadow">
                                <?php
                                    ...
                                    if (isset($_GET['question'])) {
                                        ...
                                        $_SESSION['reading-single-id'] = $question_id;
                                        $_SESSION['reading-single-num'] = $_GET['number'];
                                        ...
                                        if (isset($_SESSION['reading-single-id'])) {
                                            $question_id = $_SESSION['reading-single-id'];
                                            $sql="SELECT * FROM material_reading WHERE type='single-answer' and readingMaterialId='$question_id'";
                                        }else{
                                            $sql="SELECT * FROM material_reading WHERE type='single-answer' ";
                                        }
                                    }
                                ...
                                <div class="widget-content widget-content-area icon-pill" id="alter_pagination">
                                    ...
                                    <div class="widget-content widget-content-area icon-pill" id="alter_pagination" >
                                        <div class="row" >
                                            ...
                                            <!-- Pagination start -->
                                            <?php
                                                if (isset($_SESSION['reading-single-num'])) {
                                                    $pageNo = indexes($_SESSION['reading-single-num']);
                                                    // print_r($pageNo);
                                                }else{
                                                    $pageNo = indexes(1);
                                                    $_SESSION['reading-single-num'] = "1";
                                                    // echo $pageNo;
                                                }
                                            ?>  
                                                ...
                                                <div class="pagination-no_spacing">
                                                    <ul class="pagination">
                                                        <?php
                                                                ...
                                                                if($pageNo[1]==$_SESSION['reading-single-num']){ 
                                                                    echo '
                                                                    <li>
                                                                        <a class="prev">
                                                            ...
                                                            if ($pageNo[3] == $_SESSION['reading-single-num']) {
                                                                echo '
                                                            ...
                                                            if ($pageNo[4] != "") {
                                                                if($pageNo[5]==$_SESSION['reading-single-num']){
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" align="right">
                                                <div class="dropup" >
                                                    ...
                                                    $sql1="SELECT * FROM material_reading WHERE type='single-answer' ";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                    $tot_row1 = mysqli_num_rows($result1);
                                                    echo $_SESSION['reading-single-num']; 
                                                    ?>
                                                    of 
                                                    <?php echo $tot_row1 ?>
                                                    </button>
                                                            ...
                                                            <div class="row no-gutters">
                                                                ...
                                                                while($row1 = mysqli_fetch_assoc($result1)) { 
                                                                    ...
                                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 " >
                                                                        <a href="single_answer.php?question='.$row1['readingMaterialId'].'&number='.$i.'">
    ...
    <?php
        function indexes($value){
            include '../../database/dbh.inc.php';
            $query ="SELECT * FROM material_reading WHERE type='single-answer' ";
