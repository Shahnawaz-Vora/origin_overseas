...
<head>
    ...
    <title>Speaking: Answer Short Question | Free Materials | PTE Materials | Origin Overseas | PTE Tutors </title>
    <meta name="description" content="Free PTE Material for Speaking section's Answer Short Question questions">
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Answer Short Question</span></li>
                            </ol>
                        </nav>
                            ...
                            <div class="statbox widget box box-shadow">
                                <?php
                                    ...
                                    if (isset($_GET['question'])) {
                                        ...
                                        $_SESSION['short-answer-id'] = $question_id;
                                        $_SESSION['answer-short-num'] = $_GET['number'];
                                        $sql="SELECT * FROM material_speaking WHERE type='answer-short-question' and speakingMaterialId='$question_id'";
                                        ?><script>
                                        ...
                                        if (isset($_SESSION['short-answer-id'])) {
                                            $question_id = $_SESSION['short-answer-id'];
                                            $sql="SELECT * FROM material_speaking WHERE type='answer-short-question' and speakingMaterialId='$question_id'";
                                        }else{
                                            $sql="SELECT * FROM material_speaking WHERE type='answer-short-question' ";
                                        }
                                    }
                                       ...
                                       <div class="widget-header">
                                        ...
                                        <div class="widget-content widget-content-area">
                                                ...
                                                <audio controls id="audioFile" style="width: 220px;">
                                                    <source src="../../database/audio/<?php echo $row['audio']; ?>"></source>
                                                </audio>
                                                <div class="container-fluid">
                                                    <button id=startRecord hidden="">start</button>
                                                    <button id=stopRecord disabled hidden="">stop</button>
                                                    <center><audio id=recordedAudio style="width: 220px;"> </audio></center>
                                ...
                                <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px">
                                    <div class="widget-content widget-content-area icon-pill" id="alter_pagination">
                                        ...
                                        <div class="row mt-4" >
                                            ...
                                            <!-- Pagination start -->
                                            <?php
                                                if (isset($_SESSION['answer-short-num'])) {
                                                    $pageNo = indexes($_SESSION['answer-short-num']);
                                                    // print_r($pageNo);
                                                }else{
                                                    $pageNo = indexes(1);
                                                    $_SESSION['answer-short-num'] = "1";
                                                    // echo $pageNo;
                                                }
                                            ?>  
                                                ...
                                                <div class="pagination-no_spacing">
                                                    <ul class="pagination">
                                                        <?php
                                                                ...
                                                                if($pageNo[1]==$_SESSION['answer-short-num']){ 
                                                                    echo '
                                                                    <li>
                                                                        <a class="prev">
                                                                    ...
                                                                    echo '
                                                                    <li>
                                                                        <a href="answer_short_question.php?question='.$pageNo[0].'&number='.$pageNo[1].'" class="prev">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>    
                                                                        </a>
                                                                    </li>
                                                                    ';
                                                                    echo '<li><a href="answer_short_question.php?question='.$pageNo[0].'&number='.$pageNo[1].'">'.$pageNo[1].'</a></li>';
                                                                }
                                                            
                                                        
                                                            if ($pageNo[3] == $_SESSION['answer-short-num']) {
                                                                echo '
                                                                <li><a class="active" >'.$pageNo[3].'</a></li>
                                                                ';
                                                            }else{
                                                                echo '
                                                                <li><a href="answer_short_question.php?question='.$pageNo[2].'&number='.$pageNo[3].'">'.$pageNo[3].'</a></li>
                                                                ';
                                                            }
                                                            
                                                        
                                                            if ($pageNo[4] != "") {
                                                                if($pageNo[5]==$_SESSION['answer-short-num']){
                                                                    echo '<li><a href="answer_short_question.php?question='.$pageNo[4].'&number='.$pageNo[5].'" class="active">'.$pageNo[5].'</a></li>';
                                                                }else{
                                                                    echo '<li><a href="answer_short_question.php?question='.$pageNo[4].'&number='.$pageNo[5].'">'.$pageNo[5].'</a></li>';
                                                                }
                                                                echo '
                                                                <li>
                                                                    <a href="answer_short_question.php?question='.$pageNo[4].'&number='.$pageNo[5].'" class="next">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" align="right">
                                                <div class="dropup" >
                                                    ...
                                                    $sql1="SELECT * FROM material_speaking WHERE type='answer-short-question' ";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                    $tot_row1 = mysqli_num_rows($result1);
                                                    echo $_SESSION['answer-short-num']; 
                                                    ?>
                                                    of 
                                                    <?php echo $tot_row1 ?>
                                                    </button>
                                                            ...
                                                            <div class="row no-gutters">
                                                                ...
                                                                while($row1 = mysqli_fetch_assoc($result1)) { 
                                                                    ...
                                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 " >
                                                                        <a href="answer_short_question.php?question='.$row1['speakingMaterialId'].'&number='.$i.'">
    ...
    <!-- php pagination function -->
     <?php
        function indexes($value){
            include '../../database/dbh.inc.php';
            $query ="SELECT * FROM material_speaking WHERE type='answer-short-question' ";
