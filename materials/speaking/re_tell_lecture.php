...
<head>
    ...
    <title>Speaking: Re Tell Lacture | Free Materials | PTE Materials | Origin Overseas | PTE Tutors </title>
    <meta name="description" content="Free PTE Material for Speaking section's Re Tell Lacture questions">
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Re-tell Lecture</span></li>
                            </ol>
                        </nav>
                            ...
                            <div class="statbox widget box box-shadow">
                                <?php
                                    ...
                                    if (isset($_GET['question'])) {
                                        ...
                                        $_SESSION['re-tell-id'] = $question_id;
                                        $_SESSION['re-tell-num'] = $_GET['number'];
                                        $sql="SELECT * FROM material_speaking WHERE type='re-tell-lecture' and speakingMaterialId='$question_id'";
                                        ?><script>
                                        ...
                                        if (isset($_SESSION['re-tell-id'])) {
                                            $question_id = $_SESSION['re-tell-id'];
                                            $sql="SELECT * FROM material_speaking WHERE type='re-tell-lecture' and speakingMaterialId='$question_id'";
                                        }else{
                                            $sql="SELECT * FROM material_speaking WHERE type='re-tell-lecture' ";
                                        }
                                    }
                                    ...
                                    <div class="col-xl-12 text-center mt-5">
                                       <div class="widget-header">
                                        ...
                                        <div class="widget-content widget-content-area">
                                            ...
                                            <?php
                                                // $fileActualExt= end(explode('.',$row['audio']));
                                                $fileName= $row['audio'];
                                                ...
                                                if (in_array($fileExtension,$allowed)) {
                                                    ...
                                                    ';
                                                }if (in_array($fileExtension,$allowed_vid)) {
                                                    echo '
                                                    <video controls style="max-width:80%" id="audioFile">
                                                        <source src="../../database/video/'.$row['audio'].'" type="video/mp4">
                                                    </video>
                                                    ';
                                                }
                                            ...
                                            <div class="container-fluid">
                                                <button id=startRecord hidden="">start</button>
                                                <button id=stopRecord disabled hidden="">stop</button>
                                                <center><audio id=recordedAudio></audio></center>
                                                <a id=audioDownload hidden=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px">
                                    <div class="widget-content widget-content-area icon-pill" id="alter_pagination">
                                        ...
                                        <div class="row mt-4" >
                                            ...
                                            <!-- Pagination start -->
                                            <?php
                                                if (isset($_SESSION['re-tell-num'])) {
                                                    $pageNo = indexes($_SESSION['re-tell-num']);
                                                    // print_r($pageNo);
                                                }else{
                                                    $pageNo = indexes(1);
                                                    $_SESSION['re-tell-num'] = "1";
                                                    // echo $pageNo;
                                                }
                                            ?>  
                                                ...
                                                <div class="pagination-no_spacing">
                                                    <ul class="pagination">
                                                        <?php
                                                                ...
                                                                if($pageNo[1]==$_SESSION['re-tell-num']){ 
                                                                    echo '
                                                                    <li>
                                                                        <a class="prev">
                                                                    ...
                                                                    echo '
                                                                    <li>
                                                                        <a href="re_tell_lecture.php?question='.$pageNo[0].'&number='.$pageNo[1].'" class="prev">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>    
                                                                        </a>
                                                                    </li>
                                                                    ';
                                                                    echo '<li><a href="re_tell_lecture.php?question='.$pageNo[0].'&number='.$pageNo[1].'">'.$pageNo[1].'</a></li>';
                                                                }
                                                            
                                                        
                                                            if ($pageNo[3] == $_SESSION['re-tell-num']) {
                                                                echo '
                                                                <li><a class="active" >'.$pageNo[3].'</a></li>
                                                                ';
                                                            }else{
                                                                echo '
                                                                <li><a href="re_tell_lecture.php?question='.$pageNo[2].'&number='.$pageNo[3].'">'.$pageNo[3].'</a></li>
                                                                ';
                                                            }
                                                            
                                                        
                                                            if ($pageNo[4] != "") {
                                                                if($pageNo[5]==$_SESSION['re-tell-num']){
                                                                    echo '<li><a href="re_tell_lecture.php?question='.$pageNo[4].'&number='.$pageNo[5].'" class="active">'.$pageNo[5].'</a></li>';
                                                                }else{
                                                                    echo '<li><a href="re_tell_lecture.php?question='.$pageNo[4].'&number='.$pageNo[5].'">'.$pageNo[5].'</a></li>';
                                                                }
                                                                echo '
                                                                <li>
                                                                    <a href="re_tell_lecture.php?question='.$pageNo[4].'&number='.$pageNo[5].'" class="next">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" align="right">
                                                <div class="dropup" >
                                                    <button type="button" class="btn btn-dark ml-auto d-inline-block" style="background-color: #181c1f" data-toggle="modal" data-target="#exampleModal" id="transcript">Transcript</button>
                                                    <button class="btn dropdown-toggle btn-info d-inline-block" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="dropbtn">
                                                     <?php
                                                    include_once '../../database/dbh.inc.php';
                                                    $sql1="SELECT * FROM material_speaking WHERE type='re-tell-lecture' ";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                    $tot_row1 = mysqli_num_rows($result1);
                                                    echo $_SESSION['re-tell-num']; 
                                                    ?>
                                                    of 
                                                    <?php echo $tot_row1 ?>
                                                    </button>
                                                            ...
                                                            <div class="row no-gutters">
                                                                ...
                                                                while($row1 = mysqli_fetch_assoc($result1)) { 
                                                                    ...
                                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 " >
                                                                        <a href="re_tell_lecture.php?question='.$row1['speakingMaterialId'].'&number='.$i.'">
    ...
    <!-- php pagination function -->
     <?php
        function indexes($value){
            include '../../database/dbh.inc.php';
            $query ="SELECT * FROM material_speaking WHERE type='re-tell-lecture' ";
        ...
        function timer(){
            ...
            if(timeleft <= -1){
                if (pass == 4) {
                    ...
                    document.getElementById("counter_text").innerHTML = "Recording <span style='color:red'> will start </span>after... <span id='timeleft'></span>";
                    timeleft=10;
                    pass = 2;
                    ...
                    document.getElementById("counter_text").innerHTML = "<span style='color:red'>Recording</span> has Started... <span id='timeleft'></span>/40";
                    pass = 4;
                    document.getElementById("timeleft").innerHTML = timeleft ;
                }else{
