...
<head>
    ...
    <title>Speaking: Read a Loud | Free Materials | PTE Materials | Origin Overseas | PTE Tutors </title>
    <meta name="description" content="Free PTE Material for Speaking section's Read a Loud questions">
...
<body data-spy="scroll" data-target="#navSection" data-offset="100">
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Read a Loud</span></li>
                            </ol>
                        </nav>
                            ...
                            <div class="statbox widget box box-shadow">
                                <?php
                                    ...
                                    if (isset($_GET['question'])) {
                                        ...
                                        $_SESSION['read-a-loud-id'] = $question_id;
                                        $_SESSION['read-a-loud-num'] = $_GET['number'];
                                        $sql="SELECT * FROM material_speaking WHERE type='read-aloud' and speakingMaterialId='$question_id'";
                                        ?><script>
                                        ...
                                        if (isset($_SESSION['read-a-loud-id'])) {
                                            $question_id = $_SESSION['read-a-loud-id'];
                                            $sql="SELECT * FROM material_speaking WHERE type='read-aloud' and speakingMaterialId='$question_id'";
                                        }else{
                                            $sql="SELECT * FROM material_speaking WHERE type='read-aloud' ";
                                        }
                                    }
                                       ...
                                       <div class="widget-header">
                                            <div class="row">
                                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                                    <h4 id="counter_text">Recording <span style="color: red">will start in... </span><span id="timeleft"></span></h4>
                                                </div>                                 
                                            </div>
                                        </div>
                                ...
                                <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px">
                                    ...
                                    <div class="widget-content widget-content-area icon-pill" id="alter_pagination" >
                                        ...
                                        <div class="row" >
                                            ...
                                            <?php
                                                if (isset($_SESSION['read-a-loud-num'])) {
                                                    $pageNo = indexes($_SESSION['read-a-loud-num']);
                                                    // print_r($pageNo);
                                                }else{
                                                    $pageNo = indexes(1);
                                                    $_SESSION['read-a-loud-num'] = "1";
                                                    // echo $pageNo;
                                                }
                                            ?>  
                                                ...
                                                <div class="pagination-no_spacing">
                                                    <ul class="pagination">
                                                        <?php
                                                                ...
                                                                if($pageNo[1]==$_SESSION['read-a-loud-num']){ 
                                                                    echo '
                                                                    <li>
                                                                        <a class="prev">
                                                                    ...
                                                                    echo '
                                                                    <li>
                                                                        <a href="read_aloud.php?question='.$pageNo[0].'&number='.$pageNo[1].'" class="prev">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>    
                                                                        </a>
                                                                    </li>
                                                                    ';
                                                                    echo '<li><a href="read_aloud.php?question='.$pageNo[0].'&number='.$pageNo[1].'">'.$pageNo[1].'</a></li>';
                                                                }
                                                            
                                                        
                                                            if ($pageNo[3] == $_SESSION['read-a-loud-num']) {
                                                                echo '
                                                                <li><a class="active" >'.$pageNo[3].'</a></li>
                                                                ';
                                                            }else{
                                                                echo '
                                                                <li><a href="read_aloud.php?question='.$pageNo[2].'&number='.$pageNo[3].'">'.$pageNo[3].'</a></li>
                                                                ';
                                                            }
                                                            
                                                        
                                                            if ($pageNo[4] != "") {
                                                                if($pageNo[5]==$_SESSION['read-a-loud-num']){
                                                                    echo '<li><a href="read_aloud.php?question='.$pageNo[4].'&number='.$pageNo[5].'" class="active">'.$pageNo[5].'</a></li>';
                                                                }else{
                                                                    echo '<li><a href="read_aloud.php?question='.$pageNo[4].'&number='.$pageNo[5].'">'.$pageNo[5].'</a></li>';
                                                                }
                                                                echo '
                                                                <li>
                                                                    <a href="read_aloud.php?question='.$pageNo[4].'&number='.$pageNo[5].'" class="next">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" align="right">
                                                <div class="dropup" >
                                                    ...
                                                    $sql1="SELECT * FROM material_speaking WHERE type='read-aloud' ";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                    $tot_row1 = mysqli_num_rows($result1);
                                                    echo $_SESSION['read-a-loud-num']; 
                                                    ?>
                                                    of 
                                                    <?php echo $tot_row1 ?>
                                                    </button>
                                                        ...
                                                        <div class="dropdown-menu dd-menu">
                                                            <div class="row no-gutters">
                                                                ...
                                                                while($row1 = mysqli_fetch_assoc($result1)) { 
                                                                    if ($_SESSION['read-a-loud-num'] == $i) {
                                                                    echo '
                                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 " >
                                                                        <a href="read_aloud.php?question='.$row1['speakingMaterialId'].'&number='.$i.'">
    ...
    <!-- Modal -->
    <div class="modal animated fadeInUp" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <!-- php pagination function -->
     <?php
        function indexes($value){
            include '../../database/dbh.inc.php';
            $query ="SELECT * FROM material_speaking WHERE type='read-aloud' ";
        ...
        function timer(){
            ...
            if(timeleft <= -1){
                if (pass == 2) {
                    ...
                    document.getElementById("timeleft").innerHTML = "40";
