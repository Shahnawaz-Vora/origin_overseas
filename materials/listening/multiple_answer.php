...
<head>
    ...
    <title>Listening: Multiple-Choice, Choose Multiple Answer | Free Materials | PTE Materials | Origin Overseas | PTE Tutors </title>
    <meta name="description" content="Free PTE Material for Listening section's Multiple-Choice, Choose Multiple Answer questions">
...
<body data-spy="scroll" data-target="#navSection" data-offset="100">
                            ...
                            <div class="statbox widget box box-shadow">
                                <?php
                                    ...
                                    if (isset($_GET['question'])) {
                                        ...
                                        $_SESSION['listening-multiple-id'] = $question_id;
                                        $_SESSION['listening-multiple-num'] = $_GET['number'];
                                        ...
                                        if (isset($_SESSION['listening-multiple-id'])) {
                                            $question_id = $_SESSION['listening-multiple-id'];
                                            $sql="SELECT * FROM material_listening WHERE type='multiple-answers' and listeningMaterialId='$question_id'";
                                        }else{
                                            $sql="SELECT * FROM material_listening WHERE type='multiple-answers' ";
                                        }
                                    }
                                ...
                                <div class="text-center widget-content widget-content-area " style="margin-top: -40px;">
                                    <div class="container">
                                ...
                                <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: -25px">
                                    <div class="tab-content ml-3" id="icon-pills-tabContent">
                                        <div class="tab-pane fade show active" id="icon-pills-home" role="tabpanel" aria-labelledby="icon-pills-home-tab">
                                            <div class="container">
                                                    <h4 id="pera"><b><?php echo $row['question'] ?></b></h4>
                                    ...
                                    <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px">
                                        ...
                                        <div class="row mt-4" >
                                            ...
                                            <!-- Pagination start -->
                                            <?php
                                                if (isset($_SESSION['listening-multiple-num'])) {
                                                    $pageNo = indexes($_SESSION['listening-multiple-num']);
                                                    // print_r($pageNo);
                                                }else{
                                                    $pageNo = indexes(1);
                                                    $_SESSION['listening-multiple-num'] = "1";
                                                    // echo $pageNo;
                                                }
                                            ?>  
                                                ...
                                                <div class="pagination-no_spacing">
                                                    <ul class="pagination">
                                                        <?php
                                                                ...
                                                                if($pageNo[1]==$_SESSION['listening-multiple-num']){ 
                                                                    echo '
                                                                    <li>
                                                                        <a class="prev">
                                                            ...
                                                            if ($pageNo[3] == $_SESSION['listening-multiple-num']) {
                                                                echo '
                                                            ...
                                                            if ($pageNo[4] != "") {
                                                                if($pageNo[5]==$_SESSION['listening-multiple-num']){
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" align="right">
                                                <div class="dropup" >
                                                    ...
                                                    $sql1="SELECT * FROM material_listening WHERE type='multiple-answers' ";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                    $tot_row1 = mysqli_num_rows($result1);
                                                    echo $_SESSION['listening-multiple-num']; 
                                                    ?>
                                                    of 
                                                    <?php echo $tot_row1 ?>
                                                    </button>
                                                            ...
                                                            <div class="row no-gutters">
                                                                ...
                                                                while($row1 = mysqli_fetch_assoc($result1)) { 
                                                                    ...
                                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 " >
                                                                        <a href="multiple_answer.php?question='.$row1['listeningMaterialId'].'&number='.$i.'">
    ...
    <?php
        function indexes($value){
            include '../../database/dbh.inc.php';
            $query ="SELECT * FROM material_listening WHERE type='multiple-answers' ";
    ...
    <script type="text/javascript">
        ...
        function checkAns(){
            ...
            for(i=0;i<difference.length;i++){
                ...
                $(diff).css("background-color","#ff766ca3");
