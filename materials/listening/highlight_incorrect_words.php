...
<head>
    ...
    <title>Highlight Incorrect Words | Origin Overseas - PTE tutors </title>
    <title>Listening: Highlight Incorrect Words | Free Materials | PTE Materials | Origin Overseas | PTE Tutors </title>
    <meta name="description" content="Free PTE Material for Listening section's Highlight Incorrect Words questions">
...
<body data-spy="scroll" data-target="#navSection" data-offset="100">
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Highlight incorrect words</span></li>
                            </ol>
                        </nav>
                            ...
                            <div class="statbox widget box box-shadow">
                                <?php
                                    ...
                                    if (isset($_GET['question'])) {
                                        ...
                                        $_SESSION['highlight-incorrect-id'] = $question_id;
                                        $_SESSION['highlight-incorrect-num'] = $_GET['number'];
                                        $sql="SELECT * FROM material_listening WHERE type='highlight-incorrect-words' and listeningMaterialId='$question_id'";
                                        ?><script>
                                        ...
                                        if (isset($_SESSION['highlight-incorrect-id'])) {
                                            $question_id = $_SESSION['highlight-incorrect-id'];
                                            $sql="SELECT * FROM material_listening WHERE type='highlight-incorrect-words' and listeningMaterialId='$question_id'";
                                        }else{
                                            $sql="SELECT * FROM material_listening WHERE type='highlight-incorrect-words' ";
                                        }
                                    }
                                        ...
                                        <div class="widget-header">
                                            <div class="row">
                                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                                    <h4 class="mb-4" style="background: white;margin-top: 10px;font-size: 16px;font-weight: bold"><span style="color: red">Note:</span> You will hear a recording. Below is a transcription of the recording. Some words in the transcription differ from what the speaker(s) said. Please click on the words that are different.</h4>
                                                </div>                                 
                                            </div>
                                        </div>
                                       <div class="widget-header" style="margin-top: -5px">
                                            <div class="row">
                                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px">
                                    <div class="tab-content" id="icon-pills-tabContent">
                                        <div class="tab-pane fade show active" id="icon-pills-home" role="tabpanel" aria-labelledby="icon-pills-home-tab">
                                           <div class="container">
                                                <div class="col-xl-12 mb-2" style="margin-top: -20px;">
                                                    <p class="paragraph text-justify" style="font-size: 1.1em;line-height: 2;letter-spacing: auto;"><?php echo stripslashes($row['questionText']); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px">
                                        ...
                                        <div class="row mt-4" >
                                            ...
                                            <!-- Pagination start -->
                                            <?php
                                                if (isset($_SESSION['highlight-incorrect-num'])) {
                                                    $pageNo = indexes($_SESSION['highlight-incorrect-num']);
                                                    // print_r($pageNo);
                                                }else{
                                                    $pageNo = indexes(1);
                                                    $_SESSION['highlight-incorrect-num'] = "1";
                                                    // echo $pageNo;
                                                }
                                            ?>  
                                                ...
                                                <div class="pagination-no_spacing">
                                                    <ul class="pagination">
                                                        <?php
                                                                ...
                                                                if($pageNo[1]==$_SESSION['highlight-incorrect-num']){ 
                                                                    echo '
                                                                    <li>
                                                                        <a class="prev">
                                                                    ...
                                                                    echo '
                                                                    <li>
                                                                        <a href="highlight_incorrect_words.php?question='.$pageNo[0].'&number='.$pageNo[1].'" class="prev">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>    
                                                                        </a>
                                                                    </li>
                                                                    ';
                                                                    echo '<li><a href="highlight_incorrect_words.php?question='.$pageNo[0].'&number='.$pageNo[1].'">'.$pageNo[1].'</a></li>';
                                                                }
                                                            
                                                        
                                                            if ($pageNo[3] == $_SESSION['highlight-incorrect-num']) {
                                                                echo '
                                                                <li><a class="active" >'.$pageNo[3].'</a></li>
                                                                ';
                                                            }else{
                                                                echo '
                                                                <li><a href="highlight_incorrect_words.php?question='.$pageNo[2].'&number='.$pageNo[3].'">'.$pageNo[3].'</a></li>
                                                                ';
                                                            }
                                                            
                                                        
                                                            if ($pageNo[4] != "") {
                                                                if($pageNo[5]==$_SESSION['highlight-incorrect-num']){
                                                                    echo '<li><a href="highlight_incorrect_words.php?question='.$pageNo[4].'&number='.$pageNo[5].'" class="active">'.$pageNo[5].'</a></li>';
                                                                }else{
                                                                    echo '<li><a href="highlight_incorrect_words.php?question='.$pageNo[4].'&number='.$pageNo[5].'">'.$pageNo[5].'</a></li>';
                                                                }
                                                                echo '
                                                                <li>
                                                                    <a href="highlight_incorrect_words.php?question='.$pageNo[4].'&number='.$pageNo[5].'" class="next">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" align="right">
                                                <div class="dropup" >
                                                    ...
                                                    $sql1="SELECT * FROM material_listening WHERE type='highlight-incorrect-words' ";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                    $tot_row1 = mysqli_num_rows($result1);
                                                    echo $_SESSION['highlight-incorrect-num']; 
                                                    ?>
                                                    of 
                                                    <?php echo $tot_row1 ?>
                                                    </button>
                                                            ...
                                                            <div class="row no-gutters">
                                                                ...
                                                                while($row1 = mysqli_fetch_assoc($result1)) { 
                                                                    ...
                                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 " >
                                                                        <a href="highlight_incorrect_words.php?question='.$row1['listeningMaterialId'].'&number='.$i.'">
    ...
    <div class="modal animated fadeInUp" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
        <div class="modal-dialog modal-lg transcript-modal" role="document">
                ...
                <div class="modal-body transcript-modal-body">
                    <p class="modal-text">
                        ...
                        <?php
                            for($i=1;$i<=8;$i++)
                            {
                                if($row['option'.$i]!= "" && $row['option'.$i] != null)
                                {
                                    echo "<li>".$row['option'.$i]."</li>";
                                }
                            }
                        ?>
                        </ul>
    ...
    <?php
        function indexes($value){
            include '../../database/dbh.inc.php';
            $query ="SELECT * FROM material_listening WHERE type='highlight-incorrect-words' ";
    ...
    function checkAns(){
        var userAns = [];
        for (var i = 0; i < id; i++) {
            var ans = $('.paragraph #selected'+i).text();
        ...
        <?php
            for ($i = 1; $i <= 8 ;$i++) {
                if ($row['option'.$i] != null && $row['option'.$i]!="" && $row['option'.$i]!=" ") {
                    echo "trueAns.push('".$row['option'.$i]."');";
                }
            }
        ?>
        ...
        {
            if (intersection[i] != null && intersection[i] !="") {
                var j = userAns.indexOf(intersection[i]);
                $("#selected"+j).css("border","solid green 1px");
                $("#selected"+j).css("background-color","#adf955");
                $("#selected"+j).css("padding","0px 1px 0px 1px");
                $("#selected"+j).css("margin","5px 2px px 2px");
                $("#selected"+j).css("border-radius","5px");
                $("#selected"+j).css("font-weight","bolder");
        ...
        for(var i=0;i<userAns.length;i++)
        {
            if (difference[i] != null && difference[i] !="") {
                var j = userAns.indexOf(difference[i]);
                $("#selected"+j).css("border","solid red 1px");
                $("#selected"+j).css("background-color","#ff2c1cb0");
                $("#selected"+j).css("padding","0px 1px 0px 1px");
                $("#selected"+j).css("margin","5px 2px px 2px");
                $("#selected"+j).css("border-radius","5px");
                $("#selected"+j).css("font-weight","bolder");
        ...
        var except = trueAns.filter(element => !userAns.includes(element));
        var tot_span = $('.paragraph span').length;
        for (var j = 0; j < except.length; j++) {
            var ex = except[j].replace(/[^a-zA-Z0-9 !?]+/g, '');
            for(var i=0;i<tot_span;i++){
                var sp =  $('.paragraph span').eq(i).text().replace(/[^a-zA-Z0-9 !?]+/g, '');
                if (sp == ex) {
                    $('.paragraph span').eq(i).css("border","solid blue 1px");
                    $('.paragraph span').eq(i).css("background-color","#4678f1b3");
                    $('.paragraph span').eq(i).css("padding","0px 1px 0px 1px");
                    $('.paragraph span').eq(i).css("margin","5px 2px px 2px");
                    $('.paragraph span').eq(i).css("border-radius","5px");
                    $('.paragraph span').eq(i).css("font-weight","bolder");     
                }
            }
        }
    }
    ...
    function resetdata(){
        ...
        document.getElementById("counter_text").innerHTML = "Audio <span style='color: red'>will start in... </span><span id='timeleft'></span>";
        ...
        var tot_span = $('.paragraph span').length;
        for (var i = 0; i < tot_span; i++) {
            $('.paragraph span').eq(i).css("border","none");
            $('.paragraph span').eq(i).css("background-color","white");
            $('.paragraph span').eq(i).css("padding","0px");
            $('.paragraph span').eq(i).css("margin","0px");
            $('.paragraph span').eq(i).css("font-weight","normal");  
            $('.paragraph span').eq(i).removeAttr("id");   
        }
