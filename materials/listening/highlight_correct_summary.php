...
<head>
    ...
    <title>Listening: Highlight Correct Summary | Free Materials | PTE Materials | Origin Overseas | PTE Tutors </title>
    <meta name="description" content="Free PTE Material for Listening section's Highlight Correct Summary questions">
...
<body data-spy="scroll" data-target="#navSection" data-offset="100">
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Highlight Correct Summary</span></li>
                            </ol>
                        </nav>
                    ...
                    <div class="row layout-top-spacing">
                        <div class="col-lg-12 col-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                <?php
                                   ...
                                   include '../../database/dbh.inc.php';
                                    ...
                                    if (isset($_GET['question'])) {
                                        ...
                                        $_SESSION['highlight-correct-id'] = $question_id;
                                        $_SESSION['listening-highlight-num'] = $_GET['number'];
                                        $sql="SELECT * FROM material_listening WHERE type='highlight-correct-summary' and listeningMaterialId='$question_id'";
                                        ?><script>
                                        ...
                                        if (isset($_SESSION['highlight-correct-id'])) {
                                            $question_id = $_SESSION['highlight-correct-id'];
                                            $sql="SELECT * FROM material_listening WHERE type='highlight-correct-summary' and listeningMaterialId='$question_id'";
                                        }else{
                                            $sql="SELECT * FROM material_listening WHERE type='highlight-correct-summary' ";
                                        }
                                    }
                                ...
                                <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0;">
                                    ...
                                    <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px">
                                        ...
                                        <div class="row mt-4" >
                                            ...
                                            <!-- Pagination start -->
                                            <?php
                                                if (isset($_SESSION['listening-highlight-num'])) {
                                                    $pageNo = indexes($_SESSION['listening-highlight-num']);
                                                    // print_r($pageNo);
                                                }else{
                                                    $pageNo = indexes(1);
                                                    $_SESSION['listening-highlight-num'] = "1";
                                                    // echo $pageNo;
                                                }
                                            ?>  
                                                ...
                                                <div class="pagination-no_spacing">
                                                    <ul class="pagination">
                                                        <?php
                                                                ...
                                                                if($pageNo[1]==$_SESSION['listening-highlight-num']){ 
                                                                    echo '
                                                                    <li>
                                                                        <a class="prev">
                                                                    ...
                                                                    echo '
                                                                    <li>
                                                                        <a href="highlight_correct_summary.php?question='.$pageNo[0].'&number='.$pageNo[1].'" class="prev">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>    
                                                                        </a>
                                                                    </li>
                                                                    ';
                                                                    echo '<li><a href="highlight_correct_summary.php?question='.$pageNo[0].'&number='.$pageNo[1].'">'.$pageNo[1].'</a></li>';
                                                                }
                                                            
                                                        
                                                            if ($pageNo[3] == $_SESSION['listening-highlight-num']) {
                                                                echo '
                                                                <li><a class="active" >'.$pageNo[3].'</a></li>
                                                                ';
                                                            }else{
                                                                echo '
                                                                <li><a href="highlight_correct_summary.php?question='.$pageNo[2].'&number='.$pageNo[3].'">'.$pageNo[3].'</a></li>
                                                                ';
                                                            }
                                                            
                                                        
                                                            if ($pageNo[4] != "") {
                                                                if($pageNo[5]==$_SESSION['listening-highlight-num']){
                                                                    echo '<li><a href="highlight_correct_summary.php?question='.$pageNo[4].'&number='.$pageNo[5].'" class="active">'.$pageNo[5].'</a></li>';
                                                                }else{
                                                                    echo '<li><a href="highlight_correct_summary.php?question='.$pageNo[4].'&number='.$pageNo[5].'">'.$pageNo[5].'</a></li>';
                                                                }
                                                                echo '
                                                                <li>
                                                                    <a href="highlight_correct_summary.php?question='.$pageNo[4].'&number='.$pageNo[5].'" class="next">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" align="right">
                                                <div class="dropup" >
                                                    ...
                                                    $sql1="SELECT * FROM material_listening WHERE type='highlight-correct-summary' ";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                    $tot_row1 = mysqli_num_rows($result1);
                                                    echo $_SESSION['listening-highlight-num']; 
                                                    ?>
                                                    of 
                                                    <?php echo $tot_row1 ?>
                                                    </button>
                                                            ...
                                                            <div class="row no-gutters">
                                                                ...
                                                                while($row1 = mysqli_fetch_assoc($result1)) { 
                                                                    ...
                                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 " >
                                                                        <a href="highlight_correct_summary.php?question='.$row1['listeningMaterialId'].'&number='.$i.'">
    ...
    <?php
        function indexes($value){
            include '../../database/dbh.inc.php';
            $query ="SELECT * FROM material_listening WHERE type='highlight-correct-summary' ";
