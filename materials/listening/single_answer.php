...
<head>
    ...
    <title>Listening: Multiple-Choice, Choose Single Answer | Free Materials | PTE Materials | Origin Overseas | PTE Tutors </title>
    <meta name="description" content="Free PTE Material for Listening section's Multiple-Choice, Choose Single Answer questions">
...
<body data-spy="scroll" data-target="#navSection" data-offset="100">
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Multiple-choice, choose single answer</span></li>
                            </ol>
                        </nav>
                            ...
                            <div class="statbox widget box box-shadow">
                                <?php
                                    ...
                                    if (isset($_GET['question'])) {
                                        ...
                                        $_SESSION['listening-single-id'] = $question_id;
                                        $_SESSION['listening-single-num'] = $_GET['number'];
                                        $sql="SELECT * FROM material_listening WHERE type='single-answer' and listeningMaterialId='$question_id'";
                                        ?><script>
                                        ...
                                        if (isset($_SESSION['listening-single-id'])) {
                                            $question_id = $_SESSION['listening-single-id'];
                                            $sql="SELECT * FROM material_listening WHERE type='single-answer' and listeningMaterialId='$question_id'";
                                        }else{
                                            $sql="SELECT * FROM material_listening WHERE type='single-answer' ";
                                        }
                                    }
                                ...
                                <div class="text-center widget-content widget-content-area  " style="background: white;margin-top: 10px;font-size: 16px;font-weight: bold">
                                    <p class="mb-4"><span style="color: red">Note:</span> Listen to the recording and answer the multiple-choice question by selecting the correct response. Only one response is correct.</p>
                                </div>
                                <div class="text-center widget-content widget-content-area " style="margin-top: -40px;margin-bottom: 30px;">
                                    <div class="container">
                                ...
                                <div class="row" style="margin-top: -85px">
                                    <div class="col-xl-12 text-center mt-5">
                                        ...
                                        <div class="widget-content widget-content-area" style="margin-top: -18px">
                                                    ...
                                                    for ($i=1; $i <= 8; $i++) { 
                                                        ...
                                                        if ($row[$option] != '' || $row[$option] != null) {
                                                            ...
                                                            <label class="new-control new-radio radio-primary" id="'.$x.'">
                                                                ...
                                                                <span class="new-control-indicator"></span><span class="text-dark">'.$x.'. '.$row[$option].'</span>
                                                            </label><br/>
                                                            ';
                                    ...
                                    <div class="widget-content widget-content-area icon-pill" id="alter_pagination" style="margin-top: 0px">
                                        ...
                                        <div class="row mt-4" >
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                                ...
                                                <button type="button" class="btn" style="background-color: #e63f49;color: white;" onclick="resetdata();">Reset</button>
                                            ...
                                            <!-- Pagination start -->
                                            <?php
                                                if (isset($_SESSION['listening-single-num'])) {
                                                    $pageNo = indexes($_SESSION['listening-single-num']);
                                                    // print_r($pageNo);
                                                }else{
                                                    $pageNo = indexes(1);
                                                    $_SESSION['listening-single-num'] = "1";
                                                    // echo $pageNo;
                                                }
                                            ?>  
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4" style="margin-top: -3px;">
                                                <div class="pagination-no_spacing">
                                                    <ul class="pagination">
                                                        <?php
                                                            
                                                                if($pageNo[1]==$_SESSION['listening-single-num']){ 
                                                                    echo '
                                                                    <li>
                                                                        <a class="prev">
                                                                    ...
                                                                    echo '
                                                                    <li>
                                                                        <a href="single_answer.php?question='.$pageNo[0].'&number='.$pageNo[1].'" class="prev">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>    
                                                                        </a>
                                                                    </li>
                                                                    ';
                                                                    echo '<li><a href="single_answer.php?question='.$pageNo[0].'&number='.$pageNo[1].'">'.$pageNo[1].'</a></li>';
                                                                }
                                                            
                                                        
                                                            if ($pageNo[3] == $_SESSION['listening-single-num']) {
                                                                echo '
                                                                <li><a class="active" >'.$pageNo[3].'</a></li>
                                                                ';
                                                            }else{
                                                                echo '
                                                                <li><a href="single_answer.php?question='.$pageNo[2].'&number='.$pageNo[3].'">'.$pageNo[3].'</a></li>
                                                                ';
                                                            }
                                                            
                                                        
                                                            if ($pageNo[4] != "") {
                                                                if($pageNo[5]==$_SESSION['listening-single-num']){
                                                                    echo '<li><a href="single_answer.php?question='.$pageNo[4].'&number='.$pageNo[5].'" class="active">'.$pageNo[5].'</a></li>';
                                                                }else{
                                                                    echo '<li><a href="single_answer.php?question='.$pageNo[4].'&number='.$pageNo[5].'">'.$pageNo[5].'</a></li>';
                                                                }
                                                                echo '
                                                                <li>
                                                                    <a href="single_answer.php?question='.$pageNo[4].'&number='.$pageNo[5].'" class="next">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" align="right">
                                                <div class="dropup" >
                                                    ...
                                                    <button class="btn dropdown-toggle btn-info" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="">
                                                     <?php
                                                    include_once '../../database/dbh.inc.php';
                                                    $sql1="SELECT * FROM material_listening WHERE type='single-answer' ";
                                                    $result1 = mysqli_query($conn, $sql1);
                                                    $tot_row1 = mysqli_num_rows($result1);
                                                    echo $_SESSION['listening-single-num']; 
                                                    ?>
                                                    of 
                                                    <?php echo $tot_row1 ?>
                                                    </button>
                                                            ...
                                                            <div class="row no-gutters">
                                                                ...
                                                                while($row1 = mysqli_fetch_assoc($result1)) { 
                                                                    ...
                                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 " >
                                                                        <a href="single_answer.php?question='.$row1['listeningMaterialId'].'&number='.$i.'">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="modal-text"><?php echo $answer; ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php
        function indexes($value){
            include '../../database/dbh.inc.php';
            $query ="SELECT * FROM material_listening WHERE type='single-answer' ";
        ...
        var trueAns = "<?php echo $trueAns ?>";
            ...
            if (trueAns == userAns) {
                for (i = 0; i < option.length; i++) {
                    var id =(i+10).toString(36).toUpperCase();
                    if (trueAns == id) {
                        var id = "#"+(i+10).toString(36).toUpperCase();
                        $(id).css("border","solid green 1px");
                        $(id).css("background-color","#c1f881e3");
                        $(id).css("padding","2px 20px 7px 20px");
                        $(id).css("margin","5px 0px 5px -20px");
                ...
                for (i = 0; i < option.length; i++) {
                    ...
                    if (userAns == id) {
                        ...
                        $(id).css("background-color","#ff766ca3");
                        $(id).css("padding","2px 20px 2px 20px");
                        $(id).css("margin","5px 0px 5px -20px");
                        $(id).css("border-radius","5px");
                        $(id).css("font-weight","bolder");
                    }    
                ...
                var flase = "#" + trueAns; 
                $(flase).css("border","solid blue 1px");
                $(flase).css("background-color","#c0c0ff63");
                $(flase).css("padding","2px 20px 2px 20px");
                $(flase).css("margin","0px 0px 10px -20px");
                $(flase).css("border-radius","5px");
                $(flase).css("font-weight","bolder");
            }
