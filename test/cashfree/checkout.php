...
$notifyUrl = $host."/test/cashfree/notify.php";
$returnUrl = $host."/test/cashfree/return.php";
...
function getOrderDetails($orderId) {
  ...
  $orderAmount = $test_price;
  $sql5 = mysqli_query($conn,"SELECT * from test_purchase order by order_id desc limit 1 ");
...
$orderDetails["appId"] = "494319c6858a98fd568f9201f13494";
