                                        ...
                                        <div class="row ">
                                            <div class="col-xl-6" align="left">
                                                <div style="color: black;font-weight: bolder;font-size: 18px;margin-left: 25px;"  class="">
                                                    <button class="mb-2 btn btn-outline-danger  title-text text-dark font-weight-bold" ><span id="question_number">43</span>  of 81</button>
                                                </div>
                                            </div>
    ...
    function pageInc(){
        ...
        if(que >= 43 && que<=44)
        {
            ...
            $.ajax({
                url: 'ajax.php',
                type: 'POST',
                data: {summarize_writing_que: que,type: type,test_no:test_no,answer:answer,remaining_time: remaining_time,marks:marks},
                success: function (response) {
                    answer="";
                    var obj = JSON.parse(response);
                    // var options = [];
        ...
        if(que_inc >= 45)
        {
             window.location.replace("reading_multiple_answer.php?question="+que_inc+"&test_no="+test_no+"&continue=1&remaining_time="+remaining_time);
        }
        isPaused = false;
    }
