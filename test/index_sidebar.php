...
<div class="sidebar-wrapper sidebar-theme">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
             ...
             <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="test" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="index.php?tab=purchased"> Attempt Test </a>
                    </li>
                    <li>
                        <a href="test_table/test_results.php"> Analyze Test </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                <a href="../materials/materials.php" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
