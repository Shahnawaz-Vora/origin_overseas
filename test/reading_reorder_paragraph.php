                                    ...
                                    <div class="row ">
                                        <div class="col-xl-6" align="left">
                                            <div style="color: black;font-weight: bolder;font-size: 18px;margin-left: 25px;"  class="">
                                                <button class="mb-2 btn btn-outline-danger  title-text text-dark font-weight-bold" ><span id="question_number">47</span>  of 81</button>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    function pageInc(){
        ...
        if(que_inc >= 50)
        {
            window.location.replace("reading_fill_in_the_blanks.php?question="+que_inc+"&test_no="+test_no+"&continue=1&remaining_time="+remaining_time);
        }
        isPaused = false;
    }
    resetOption();  
