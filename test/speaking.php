                                    ...
                                    <div class=" mt-5 text-left text-dark">
                                        ...
                                        <div align="center" class="mt-4 mb-2">
                                            ...
                                            if(isset($_GET['testno']) && isset($_GET['question']) && isset($_GET['type']) && isset($_GET['section']) )
                                            {
                                                ...
                                                if($type == 'read-aloud')
                                                {
                                                    ?><button class="btn btn-rounded btn-info" type="button" onclick=location.href='speaking_section.php?testno=<?php echo $test_no; ?>&question=<?php echo $question; ?>&type=<?php echo $type; ?>&resume=1'>Next</button>
                                                    <?php
                                                }
                                                ...
                                                {
                                                    ?>
                                                    <button class="btn btn-rounded btn-info" type="button" onclick=location.href='speaking_section.php?testno=<?php echo $test_no; ?>&question=1' style="padding: 7px 50px 7px 50px;">Next</button>
                                                    <?php
                                                }
                                            ?>
                                        </div>
