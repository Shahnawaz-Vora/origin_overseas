    ...
    <script type="text/javascript">
        $("#prev").click(function(event) {
            <?php
                ...
                else
                {
                    ...
                    $sql6 = mysqli_query($conn , "select id from test where test_no='$test_no' and section='speaking' and type='read-aloud' and question_no='$question_prev'");
        ...
        $("#next").click(function(event) {
            <?php
                if($question_no == 7)
                {
                    $sql6 = mysqli_query($conn , "select id from test where test_no='$test_no' and section='speaking' and type='repeat-sentence' and question_no='1'");
                    $row6= mysqli_fetch_assoc($sql6);  
                    $id= $row6['id'];
                    ?>
                ...
                else
                {
                    ...
                    $sql6 = mysqli_query($conn , "select id from test where test_no='$test_no' and section='speaking' and type='read-aloud' and question_no='$question_next'");
                    $row6= mysqli_fetch_assoc($sql6); 
                    $id= $row6['id'];
                    ?>
                    location.replace("speaking_read_a_loud.php?question=<?php echo $id; ?>");
